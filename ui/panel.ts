...
export class MetadataPanel extends ItemView {
  ...
  private renderPanel(): void {
    ...
    contentEl.createDiv({ cls: "simplicial-panel-title", text: "Simplex" });
    if (!simplex) {
      contentEl.createDiv({ text: "Select a simplex or an encounter." });
      return;
    }
    ...
    contentEl.createDiv({ cls: "simplicial-panel-section-label", text: "Nodes" });
    contentEl.createDiv({ cls: "simplicial-panel-value", text: simplex.nodes.join(" · ") });
  ...
  private renderHyperedgePanel(contentEl: HTMLElement, key: RelationKey): void {
    contentEl.createDiv({ cls: "simplicial-panel-title", text: "Encounter" });
    const hyperedge = this.model.getHyperedge(key);
    if (!hyperedge) {
      contentEl.createDiv({ text: "This encounter is no longer in the graph." });
      return;
    }
    ...
    contentEl.createDiv({ cls: "simplicial-panel-section-label", text: "Participants" });
    contentEl.createDiv({ cls: "simplicial-panel-value", text: hyperedge.nodes.join(" · ") });
  ...
  private renderEncounterDiagnostics(
    ...
    section.createDiv({ cls: "simplicial-panel-section-label", text: "Diagnostics" });
  ...
  private renderJourney(contentEl: HTMLElement, nodes: string[], key: RelationKey): void {
    ...
    section.createDiv({ cls: "simplicial-panel-section-label", text: "Journey" });
  ...
  private renderMeasure(
    ...
    head.createSpan({ cls: "simplicial-measure-name", text: name });
    head.createSpan({ cls: "simplicial-measure-figure", text: figure });
    if (fill !== null) {
    ...
    if (reading) row.createDiv({ cls: "simplicial-measure-reading", text: reading });
  }
