...
var gn = (r, e) => {
  ...
  mn = (r, e, t, n) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let i of pn(e))
        !un.call(r, i) && i !== t && ke(r, i, { get: () => e[i], enumerable: !(n = hn(e, i)) || n.enumerable });
    return r;
  };
var fn = (r) => mn(ke({}, "__esModule", { value: !0 }), r);
var vi = {};
gn(vi, { default: () => Te });
module.exports = fn(vi);
...
var yn = { simplex: "s", hyperedge: "h" };
function E(r, e) {
  return `${yn[r]}:${N(e)}`;
}
function P(r) {
  return [...r].sort((e, t) => Y(e).localeCompare(Y(t)));
}
function j(r) {
  let e = new Set(),
    t = [];
...
function* oe(r, e) {
  ...
  for (let t = 0; t <= r.length - e; t++) for (let n of oe(r.slice(t + 1), e - 1)) yield [r[t], ...n];
}
function Ie(r, e) {
  if (Qe(e) >= 4) return [];
  let n = P(e.nodes),
    i = [];
  for (let s = 2; s < n.length; s++) for (let o of oe(n, s)) r.simplices.has(N(o)) || i.push(P(o));
  return i;
}
function et(r, e) {
  let t = Qe(e);
...
function De(r, e = 2) {
  ...
  e >= 1 && l.push(...Sn(n, i, s));
  let c = [];
  return (e >= 2 && c.push(...xn(s, o)), { b0: a, b1: l.length, b2: c.length, holes: [...l, ...c] });
}
function bn(r, e) {
...
function xn(r, e) {
  ...
  for (let [l, c] of a) {
    ...
    h === 4 && t.push({ dimension: 2, boundaryNodes: u, missingSimplex: u });
  }
  return t;
}
function wn(r) {
...
function Cn(r, e, t) {
  ...
  switch (Math.floor(Math.random() * 4)) {
    case 0:
      return { px: le(-s, s), py: -o };
    case 1:
      return { px: s, py: le(-o, o) };
    case 2:
      return { px: le(-s, s), py: o };
    default:
      return { px: -s, py: le(-o, o) };
...
var ce = class {
  ...
  setNode(e, t) {
    ...
    let i = Nn(e, void 0, t?.isVirtual ?? !1);
  ...
  updateNodeId(e, t) {
    ...
    for (let [i, s] of [...this.simplices]) {
      ...
      let o = { ...s, nodes: P(s.nodes.map((a) => (a === e ? t : a))) };
  ...
  addSimplex(e) {
    ...
    let n = {
      ...
      i = N(n.nodes);
    return (this.simplices.set(i, n), et(this, n), this.invalidateAnalysisCache(), this.emitChange(), i);
  }
  removeSimplex(e) {
  ...
  updateHyperedge(e, t) {
    ...
    return (
      ...
      t.weight !== void 0 && (i.weight = de(t.weight)),
  ...
  facesImpliedByPromotion(e) {
    ...
    return t ? Ie(this, { nodes: t.nodes }) : [];
  }
  ...
  getAllRelations() {
    ...
    return (
      this.simplices.forEach((t, n) => {
        e.push({ key: E("simplex", t.nodes), relation: { kind: "simplex", ...t } });
      }),
  ...
  computeAnalysisSummary() {
    ...
    return {
      ...
      edgeCount: t.length,
      clusterCount: e.filter((g) => g.nodes.length === 3).length,
      coreCount: e.filter((g) => g.nodes.length >= 4).length,
      inferredCount: e.filter((g) => g.inferred).length,
      suggestedCount: e.filter((g) => g.suggested).length,
...
var Mn = new Set(["encountered", "recurred", "created", "promoted", "relaxed", "crystallized", "dissolved"]);
function nt(r) {
...
function it(r) {
  ...
  return !Mn.has(n) || s.length === 0 || Number.isNaN(o)
    ? null
    : Object.freeze({
        timestamp: o,
        type: n,
...
var dt = { parse: (r) => (0, V.parseYaml)(r) ?? null, stringify: (r) => (0, V.stringifyYaml)(r) };
function q(r, e) {
  return at(r, e, dt);
}
function Z(r) {
...
function Ae(r, e, t) {
  return Fe(r, "simplices", e, t);
}
function He(r, e, t) {
  return Fe(r, "hyperedges", e, t);
}
async function Le(r, e, t) {
  let n = await r.vault.read(e),
    { frontmatter: i, body: s } = Z(n),
    o = N(t.nodes);
  Ae(i, o, ct(t));
...
async function ut(r, e, t) {
  let n = await B(r, e),
    ...
    { frontmatter: s, body: o } = Z(i),
    a = N(t.nodes);
  ((s.managedBy = "simplicial-complex"), He(s, a, ht(t)));
  let l = q(
    s,
    o ||
...
async function mt(r, e, t) {
  let n = await B(r, e),
    ...
    { frontmatter: s, body: o } = Z(i),
    a = N(t.nodes);
  ((s.managedBy = "simplicial-complex"), Ae(s, a, ct(t)));
...
`),
  pe = class {
    ...
    async load(e) {
      ...
      if (!(t instanceof Oe.TFile)) return 0;
        ...
        : ((this.flushing = (async () => {
            try {
              for (; this.queue.length > 0; ) {
                let t = this.queue.splice(0, this.queue.length).map((n) => nt(n)).join(`
`);
...
var Pn = { k: 8, minClusterSize: 3, maxIterations: 100 };
function Ke(r, e = {}) {
  let t = { ...Pn, ...e };
...
function Rn(r, e, t, n, i = 0) {
  ...
  l && c ? (s += 0.8) : (l || c) && (s += 0.5);
  let u = Dn(r.tags, e.tags),
    h = [...t.values()].flatMap((v) => [...v.tags]),
    p = new Map();
...
function Be(r, e) {
  let t = new Map(),
    ...
    i;
  if (e.domainSource === "content-cluster") i = Ke(r, { k: e.contentClusterCount });
  else if (e.domainSource === "hybrid") {
    let p = Ke(r, { k: e.contentClusterCount });
    i = vt(r, p);
  ...
  for (let o of n) {
    ...
    for (let l = 0; l < a.length; l++)
      for (let c = l + 1; c < a.length; c++) {
        ...
        t.push({ nodes: [u, o, h], source: "inferred-bridge", bridgeNode: o, triadScore: f, label: null, weight: g });
      }
  }
  return t;
}
...
function _e(r, e) {
  ...
  for (let c of r.nodes.keys()) {
    if (o.has(c) || O(c, t, r).length < n) continue;
    let h = new Set([c]),
      p = [c];
...
function Nt(r, e, t = Hn, n, i) {
  let s = Date.now(),
    o = Math.max(...e.map((h) => h.modifiedAt)),
    a = (s - o) / (1e3 * 60 * 60 * 24),
    l = e.reduce((h, p) => h + t.roleModifier[p.role], 0) / e.length,
    c = Math.pow(0.5, (a * l) / t.halfLifeDays),
    u = r * c;
  if (t.enableReinforcement && n) {
    let h = e.map((m) => m.id),
      d = 1 + (st(n, i, h) - 1) * t.reinforcementStrength;
    u *= d;
  }
  return Math.max(t.minimumWeight, Math.min(1, u));
}
function ze(r, e, t) {
  let n = r.nodes.map((f) => e.find((g) => g.id === f)),
    i = n.length - 1,
    s = r.triadScore ?? 0,
  ...
  if (((s -= p * t.commonTagPenalty), !wt(n, i)))
    return { ...r, insightScore: 0, class: "folder-cluster", decayedWeight: 0 };
  let d =
    i === 2 ? Ct(n, t.minDomainsForTetra, t.minRolesForTetra) : { qualifies: !0, isSuper: !1, class: "cross-domain" };
  if (!d.qualifies) return { ...r, insightScore: 0, class: "folder-cluster", decayedWeight: 0 };
  let m = Nt(r.weight ?? 1, n, {
...
function Ln(r, e) {
  ...
  let a = [...s.values()]
      .map((d) => ze(d, [...t.nodes.values()], e))
      .filter((d) => d.insightScore >= e.insightThreshold && d.class !== "folder-cluster")
    ...
    c = [...t.edges.values()]
      ...
      .filter((d) => d > 0)
      .sort((d, m) => m - d),
    u = 1 - e.linkStrengthThreshold,
    h = Math.max(0, Math.floor(c.length * u) - 1),
    p = c[h] ?? 0;
  for (let d of t.edges.values())
    d.strength >= p &&
      l.push({
        nodes: [d.a, d.b],
        weight: d.strength,
        ...
        inferred: !0,
        userDefined: !1,
        suggested: d.strength >= e.closureThreshold,
        colorKey: "neutral",
...
var Et = new Set([
  ...
  Bn = { en: Et, fa: On, es: Kn, fr: Wn, de: $n };
function _n(r) {
  let e = r.toLowerCase().split("-")[0];
  return Bn[e] ?? Et;
}
function Pt(r, e = "en") {
  return _n(e).has(r.toLowerCase());
}
var zn = "en";
function It(r, e = zn) {
  return new Set(
...
function Yn(r) {
  let e = new Set();
  r?.tags?.forEach((i) => e.add(Dt(i.tag)));
  let t = r?.frontmatter?.tags;
  return ((Array.isArray(t) ? t : typeof t == "string" ? [t] : []).forEach((i) => e.add(Dt(String(i)))), e);
}
function Xn(r, e, t) {
  let n = new Set();
  return (
      ...
      Gn(a, s, o).forEach((c) => {
        ...
        if (
          (e.enableLinkInference !== !1 &&
            ...
            ((f = !0), (d += e.linkWeight), m.push("link:a->b")),
          e.enableMutualLinkBonus !== !1 &&
            p.outgoingLinks.has(h.path) &&
            ((f = !0), (d += e.mutualLinkBonus), m.push("link:b->a")),
          !e.linkGraphBaseline && f && ((d = 0), (f = !1), (m.length = 0)),
          !e.enableInferredEdges && !f)
        )
          return;
        let g = Ft(h.tags, p.tags);
        ...
        let y =
          e.enableInferredEdges && e.enableTitleOverlap !== !1
            ? Rt(h.titleTokens, p.titleTokens, e.titleOverlapWeight)
            : 0;
        y > 0 && ((d += y), m.push(`title:${y.toFixed(2)}`));
        let v =
          e.enableInferredEdges && e.enableContentOverlap !== !1
            ? Rt(h.contentTokens, p.contentTokens, e.contentOverlapWeight)
            : 0;
        if (
          (v > 0 && ((d += v), m.push(`content:${v.toFixed(2)}`)),
          e.enableInferredEdges && e.enableSameFolderInference !== !1 && h.folder && h.folder === p.folder
            ? ((d += e.sameFolderWeight), m.push("folder:same"))
            : e.enableInferredEdges &&
              e.enableSameTopFolderInference !== !1 &&
              h.topFolder &&
              h.topFolder === p.topFolder &&
              ((d += e.sameTopFolderWeight), m.push("folder:top")),
          !f && d < e.inferenceThreshold)
        )
          return;
        ...
        (t.push({
          ...
          n.set(ue(h.path, p.path), { nodes: [h.path, p.path], weight: b, signals: [...m] }));
      });
    }),
    e.enableInferredEdges)
  ) {
...
function Ht(r, e) {
  let t = e.inferenceMode ?? "taxonomic",
    n = [];
  return (
    (t === "taxonomic" || t === "hybrid") && n.push(...je(r, e)),
    (t === "emergent" || t === "hybrid") && n.push(...Mt(r, e)),
    n
  );
}
var $t = require("obsidian");
var Lt = /^(△+|simplex:)\s+(.+)$/gim,
  Ot = /^(◇|hyperedge:|encounter:)\s+(.+)$/gim;
function Un(r, e) {
  let t = r.match(/^---\n([\s\S]*?)\n---/);
  if (!t) return null;
  try {
...
function Jn(r, e, t) {
  ...
  Lt.lastIndex = 0;
  let i;
  for (; (i = Lt.exec(r)) !== null; ) {
    let s = i[1],
      o = i[2].split(/\s+/).filter(Boolean),
      a = s === "\u25B3\u25B3" ? 4 : s === "\u25B3" ? 3 : o.length,
      l = j(o.slice(0, a).map((c) => t.canonicalize(c)));
...
function Wt(r, e, t) {
  ...
  (i.simplices.push(...Jn(r, e, t)), i.hyperedges.push(...Qn(r, e, t)));
  let s = ei(i);
  return (
...
function Bt(r, e, t) {
  return Wt(r, e, {
    ...
    parseYaml: (i) => (0, $t.parseYaml)(i) ?? null,
  });
}
var ge = class {
  constructor(e, t, n, i, s) {
    ...
    ((this.debouncedChange = (0, G.debounce)(
      ...
      this.app.vault.on("modify", (o) => {
        (X(), o instanceof G.TFile && this.debouncedChange(o));
      }),
      ...
      this.app.vault.on("rename", (o, a) => {
        (X(), o instanceof G.TFile && this.onFileRename(o, a));
      }));
  }
  recordWrite(e, t) {
  ...
  processFile(e, t) {
    ...
    (this.model.replaceSourceRelations(e.path, n.simplices, n.hyperedges),
      ...
      this.inferenceContexts.set(e.path, At(this.app, e, t)),
  ...
  rebuildInferredSimplices() {
    ...
    if (
      ...
      if (
        ((e = Tt([...this.inferenceContexts.values()], this.settings, n)), this.settings.inferenceMode === "hybrid")
      ) {
        let i = je([...this.inferenceContexts.values()], this.settings),
...
var me = class {
  ...
  getFocusState() {
    ...
    (i &&
      ...
      this.model.getHyperedgesForNode(i).forEach((o) => {
        (n.add(E("hyperedge", o.nodes)), o.nodes.forEach((a) => e.add(a)));
      })),
    ...
    let s = (o, a) => {
      if (o.kind === "hyperedge") {
        ...
        return n.has(c) || o.nodes.some((u) => e.has(u));
      }
      let l = a ?? N(o.nodes);
      return t.has(l) || o.nodes.some((c) => e.has(c));
    };
    return {
  ...
  lerpAlpha(e, t) {
    ...
    e.displayAlpha = ti(e.displayAlpha, n, 0.12);
  }
...
var Ve = class r {
  ...
  fe = class {
    ...
    tick(e, t, n, i, s = []) {
      let a =
          t.filter((g) => g.nodes.length === 2).length > 0 &&
          t.every((g) => g.nodes.length <= 2 || g.inferred) &&
          !s.some((g) => g.nodes.length >= 3),
        l = new Map(e.map((g) => [g.id, g])),
        c = new Map(),
        u = new Map();
      (e.forEach((g) => {
        ...
        t.forEach((g) => {
          ...
          for (let S = 0; S < g.nodes.length; S++)
            for (let w = S + 1; w < g.nodes.length; w++) {
              let T = zt(g.nodes[S], g.nodes[w]),
                I = (c.get(T) ?? 0) + v * b;
              c.set(T, Math.min(3.5, I));
            }
        }));
      let h = e.length > 0 ? this.calculateBounds(e) : { x: 0, y: 0, width: 1e3, height: 1e3 },
        p = new Ve(h.x, h.y, h.width, h.height);
      (e.forEach((g) => p.insert(g)),
        e.forEach((g) => {
      ...
      for (let g = 0; g < e.length; g++)
        for (let y = g + 1; y < e.length; y++) {
          let v = e[g],
            ...
            w = b.py - v.py,
            T = Math.hypot(S, w) || 1,
            I = c.get(zt(v.id, b.id)) ?? 0,
            D = S / T,
            L = w / T,
            J = Math.max(0, this.MIN_NODE_SEPARATION - T);
          if (J > 0 && !this.USE_BARNES_HUT) {
            let K = J * this.COHESION * 0.55;
            (v.isPinned || ((v.vx -= K * D), (v.vy -= K * L)), b.isPinned || ((b.vx += K * D), (b.vy += K * L)));
          }
          if (I > 0) {
            let K = Math.min(1.6, I),
              ne = Math.max(this.MIN_NODE_SEPARATION * 1.05, this.SPARSE_EDGE_LENGTH * (1.08 - K * 0.2)),
              Q = (T - ne) * this.COHESION * 0.16 * (1 + I * 0.9),
              ie = ne * 0.68,
              W = Math.max(0, ie - T) * this.COHESION * 0.28 * (1 + I * 1.1);
            (v.isPinned || ((v.vx += Q * D - W * D), (v.vy += Q * L - W * L)),
              b.isPinned || ((b.vx -= Q * D - W * D), (b.vy -= Q * L - W * L)));
          }
        }
      if (
        (t.forEach((g) => {
      ...
      let d =
        e.length > 0
          ? { x: e.reduce((g, y) => g + y.px, 0) / e.length, y: e.reduce((g, y) => g + y.py, 0) / e.length }
          : { x: 0, y: 0 };
      e.forEach((g) => {
        if (g.isPinned) return;
      ...
      let m = e.reduce((g, y) => g + y.vx * y.vx + y.vy * y.vy, 0);
...
function Gt(r) {
  if (r.inferred) {
    let e = ii(r);
    return r.nodes.length >= 3 ? jt(r) : Xt(e, r);
  }
  return jt(r);
}
function si(r, e) {
  let t = [...r.simplices.values()].filter((s) => s.nodes.length > e.nodes.length && Vt(e.nodes, s.nodes));
  if (!t.length) return null;
  let n = t.sort((s, o) => o.nodes.length - s.nodes.length || s.nodes.join("|").localeCompare(o.nodes.join("|")))[0];
  return t.some((s) => !Vt(s.nodes, n.nodes)) ? null : n;
}
function F(r, e) {
  if (!r) return Gt(e);
  let t = si(r, e);
...
function li(r, e, t, n) {
  ...
  else if (Zt(o)) (Ge(g, o[0], o[o.length - 1], n), g.fill());
  else
    for (let v = 0; v < s.length; v++) {
      for (let b = v + 1; b < s.length; b++)
        (Ge(g, { x: s[v].px, y: s[v].py }, { x: s[b].px, y: s[b].py }, n), g.fill());
...
function Jt(r, e, t, n, i, s) {
  ...
  (o.length === 2 || Zt(h) ? Ge(r, h[0], h[h.length - 1], p) : ai(r, oi(ri(h), p)),
    r.fill(),
    r.stroke(),
    r.setLineDash([]),
...
function Qt(r, e, t, n, i, s, o) {
  if (!Ye(t, i).length) return;
  let [l, c, u] = F(n, t),
    h = 36 + (t.weight ?? 1) * 24 + (t.nodes.length - 1 === 3 ? 20 : 0),
    p = o.isActive ? (o.involvesSimplex(t, e) ? s : s * 0.18) : s,
    d = li(`s:${e}`, t, i, h);
  if (!d) return;
  [
...
function nn(r, e, t, n, i) {
  ...
  for (let l of s.betti.holes) ci(r, l, a, t, n, i);
  r.restore();
}
function ci(r, e, t, n, i, s) {
...
function sn(r, e, t, n) {
  ...
  return r.inferred ? hi(r, s, t, o) : r.autoGenerated ? pi(r) : ui(r, s);
}
function hi(r, e, t, n) {
...
var be = class {
  ...
  rankVisibleNodes(e, t) {
    ...
    return [...e].sort((a, l) => {
      let c = this.nodeVisualPriority(a),
        ...
        d = (a.id === s ? 6 : 0) + (a.id === o ? 5 : 0) + (t.has(a.id) ? 4 : 0) + (a.isPinned ? 2 : 0) + h,
        m = (l.id === s ? 6 : 0) + (l.id === o ? 5 : 0) + (t.has(l.id) ? 4 : 0) + (l.isPinned ? 2 : 0) + p;
      if (d !== m) return m - d;
  ...
  findSimplexAtPoint(e) {
    ...
    for (let i of t) {
      ...
      if (s.length === 2) {
        ...
        if (
          e.x >= Math.min(o.x, a.x) - h &&
          e.x <= Math.max(o.x, a.x) + h &&
          e.y >= Math.min(o.y, a.y) - h &&
          e.y <= Math.max(o.y, a.y) + h &&
      ...
      if (!(o.length < 2)) {
        if (o.length === 2) {
          let [a, l] = o,
            c = l.x - a.x,
            u = l.y - a.y,
            h = Math.abs(u * e.x - c * e.y + l.x * a.y - l.y * a.x) / (Math.hypot(c, u) || 1),
  ...
  hyperedgeColor(e) {
    return F(null, { nodes: e.nodes, label: e.label, colorKey: e.colorKey, sourcePath: e.sourcePath });
  }
  ...
  drawHoveredNodeOverlay(e) {
    ...
    let h = e.measureText(i).width;
    e.font = "500 12px system-ui, sans-serif";
    let p = s ? Math.min(320, e.measureText(s).width) : 0,
    ...
    ((e.fillStyle = `rgb(${a},${l},${c})`),
      ...
      s &&
        ...
        (e.shadowBlur = 8),
        (e.font = "500 12px system-ui, sans-serif"),
        this.drawWrappedText(e, s, f, g + 36, d, 16)),
      e.restore());
  }
  drawFormalSimplex(e, t, n) {
    let i = ve(t, this.model.getAllNodes());
    if (i.length < 2) return;
    let [s, o, a] = F(this.model, t),
      l = n ? 0.8 : 0.28;
    if (
      (e.save(),
    ...
    (this.settings.formalMode
      ...
      : l.forEach(([d, m]) => {
          ...
          (f === 1 && !this.settings.showEdges) ||
            (f === 2 && !this.settings.showClusters) ||
            (f >= 3 && !this.settings.showCores) ||
            (Qt(e, d, m, this.model, t, this.alphaForDimension(f, i.isActive), i), this.drawSuggestionOverlay(e, d, m));
        }),
      this.settings.formalMode ||
        en(
          e,
      ...
      o.forEach((d) => {
        ...
        (m &&
          (e.beginPath(), e.arc(d.px, d.py, 15, 0, Math.PI * 2), (e.fillStyle = `rgba(${y},${v},${b},0.10)`), e.fill()),
          e.beginPath(),
          d.isVirtual
            ? (e.arc(d.px, d.py, this.settings.formalMode ? 4.5 : m ? 7 : 5, 0, Math.PI * 2),
              (e.strokeStyle = `rgba(${y},${v},${b},${d.displayAlpha})`),
              (e.lineWidth = 1.5),
              e.stroke())
            : (e.arc(d.px, d.py, this.settings.formalMode ? 4.5 : m ? 7 : 5, 0, Math.PI * 2),
              (e.fillStyle = `rgba(${y},${v},${b},${f ? d.displayAlpha : 0.2})`),
              e.fill()),
          d.isPinned &&
            (e.beginPath(),
            ...
            e.lineTo(d.px - 5, d.py - 13),
            e.closePath(),
            (e.fillStyle = `rgba(${y},${v},${b},0.8)`),
            e.fill()),
          (e.font = `${m ? "500" : "400"} 12px system-ui, sans-serif`));
        let S = this.formatNodeLabel(d.id),
          w = h < p,
          T = this.canPlaceLabelFast(u, S, d.px, d.py - 13),
          I = this.measureTextWidth(e, S) + 12,
          D = this.nodeVisualPriority(d),
          J = m || i.lockedNodeId === d.id || d.isPinned,
          K = D.bucket >= 3,
          ne = D.bucket === 2,
          qe = D.bucket === 0;
        if (
          !(J || (K && w && T) || (ne && h < Math.max(2, Math.floor(p * 0.45)) && T) || (!qe && i.isActive && w && T))
        )
          return;
        J || h++;
        let ie = 18,
      ...
      this.settings.bettiDisplayOnCanvas && this.settings.enableBettiComputation && tn(e, this.model, this.isDark),
      this.settings.enableBettiComputation &&
        nn(e, this.model, this.isDark, this.getVisibleWorldBounds(), this.hoveredHoleKey));
  }
  ...
  Se = class extends A.Modal {
    ...
    render() {
      ...
      (new A.Setting(t)
        ...
        new A.Setting(t).setName("Label").addText((s) => {
...
var xe = class extends we.Modal {
  ...
  onOpen() {
    ...
    if (
      ...
      t.createEl("p", {
        text: `You are asserting that ${this.nodes.map(rn).join(" \xB7 ")} is not only meaningful as a whole, but that its sub-relations are meaningful too.`,
      }),
      this.faces.length === 0)
    )
      ...
      this.faces.forEach((i) => {
        n.createEl("li", { text: i.map(rn).join(" \u2014 ") });
      });
    }
    (t.createEl("p", {
...
function an(r) {
  ...
  return (
    r.hyperedges.forEach((i, s) => {
      let o = i.nodes,
        a = o.length,
        l = a <= on ? 2 ** a - a - 1 : Number.POSITIVE_INFINITY;
      if (a > on) {
      ...
      t.set(s, { key: s, nodes: o, presentFaces: c, missingFaces: u, impliedFaceCount: l, unbounded: !1 });
    }),
    r.writeCrossLayerCache({ hyperedges: t, simplexCoveredBy: n })
  );
}
var Ce = class extends k.ItemView {
  constructor(t, n) {
    super(t);
    this.model = n;
  ...
  renderPanel() {
    ...
    (new k.Setting(t).setName("Label").addText((h) => {
  ...
  renderHyperedgePanel(t, n) {
    ...
    let s = t.createDiv({ cls: "simplicial-panel-badges" }),
      o = [127, 119, 221];
    ...
    (new k.Setting(t)
      ...
      new k.Setting(t).addExtraButton((h) => {
        (h.setIcon("trash"),
...
async function Ue(r, e, t) {
  ...
  for (;;) {
    let s = `${n}${i === 0 ? "" : `-${i}`}.md`;
    if (!(r.vault.getAbstractFileByPath(s) instanceof k.TFile)) return r.vault.create(s, t);
    i++;
  }
}
...
function ln(r, e) {
  let t = [],
    n = [...r.simplices.entries()]
      .map(([a, l]) => ({ key: a, simplex: l, weight: fi(l, e) }))
    ...
    if (c === 0)
      for (let u of a.nodes)
        i.has(u) ||
          (i.add(u),
          s.set(u, new Set([u])),
          t.push({ threshold: l, type: "edge-appear", nodes: [u], description: `Node ${u} appears` }));
    else if (c === 1) {
      let [u, h] = a.nodes,
        p = s.get(u),
        d = s.get(h);
...
var Ne = class extends cn.ItemView {
  ...
  computeFiltrationEvents() {
    ...
    (this.sliderWrap && this.sliderWrap.removeClass("simplicial-hidden"),
      (this.filtrationEvents = ln(this.model, this.settings.renderFilterMetric)),
  ...
  updateEventMarkers() {
    if (
      ...
      return;
    let t = dn(this.filtrationEvents);
...
var Te = class extends M.Plugin {
  ...
  async onload() {
    ...
    (n && this.controller.setInteractionTracker(ot(n)),
...
${s.prompt}`,
  ...
  syncEncounterState() {
    tt(this.model, this.history, this.settings.encounterRecurrenceThreshold);
  }
  ...
  async persistHyperedge(t) {
    if (
      ...
      let { file: o, content: a } = await ut(this.app, this.settings.centralFile, {
        ...t,
...
`),
  ...
  async logPersistenceState() {
    (C.info("plugin", "Persistence state", {
      ...
      this.settings.persistenceMode === "central-file"
        ? await ft(this.app, this.settings.centralFile)
  ...
  async openPanel(t, n) {
    ...
    (await i.setViewState({ type: U, active: n }),
