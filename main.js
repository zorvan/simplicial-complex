...
var _i = (r, t) => {
  ...
  Wi = (r, t, e, n) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of Ki(t))
        !Bi.call(r, i) && i !== e && ot(r, i, { get: () => t[i], enumerable: !(n = Oi(t, i)) || n.enumerable });
    return r;
  };
var zi = (r) => Wi(ot({}, "__esModule", { value: !0 }), r);
var Nr = {};
_i(Nr, { default: () => nt });
module.exports = zi(Nr);
...
function q(r) {
  ...
  return r ? t[X(r) % t.length] : "purple";
}
function oe(r) {
  return r.toLowerCase().trim();
}
function w(r) {
  return [...r].map(oe).sort().join("|");
}
...
function I(r) {
  return [...r].sort((t, e) => oe(t).localeCompare(oe(e)));
}
function Z(r) {
  let t = new Set(),
    e = [];
...
function Ee(r, t, e) {
  ...
  return i || (Vi(e).get(oe(n)) ?? null);
}
var ye = "simplicial-view",
  le = "simplicial-panel",
  ve = "simplicial-sheaf",
  be = "simplicial-dynamics";
function Kt(r) {
...
function* ce(r, t) {
  ...
  for (let e = 0; e <= r.length - t; e++) for (let n of ce(r.slice(e + 1), t - 1)) yield [r[e], ...n];
}
function ct(r, t) {
  if (Kt(t) >= 4) return [];
  let n = I(t.nodes),
    i = [];
  for (let s = 2; s < n.length; s++) for (let o of ce(n, s)) r.simplices.has(w(o)) || i.push(I(o));
  return i;
}
function Bt(r, t) {
  let e = Kt(t);
...
function _t(r, t) {
  ...
  for (let o of e.boundaries) n[o.dimension] = Xi(o.data);
...
function j(r, t = 2) {
  ...
  let n = [];
  return (t >= 1 && n.push(...qi(r, e)), t >= 2 && n.push(...Zi(e)), n);
}
function qi(r, t) {
  ...
  for (let [o, a] of e) {
    ...
    for (let c = 0; c < l.length; c++)
      for (let u = c + 1; u < l.length; u++) {
        ...
        let p = I([o, d, h]),
          v = w(p);
        n.has(v) || i.has(v) || (i.add(v), s.push({ dimension: 1, boundaryNodes: p, missingSimplex: [...p] }));
      }
  }
...
var Te = class {
  ...
  setNode(t, e) {
    ...
    let i = es(t, void 0, e?.isVirtual ?? !1);
  ...
  updateNodeId(t, e) {
    ...
    for (let [i, s] of [...this.hyperedges]) {
      if (!s.nodes.includes(t)) continue;
      let o = { ...s, nodes: I(s.nodes.map((a) => (a === t ? e : a))) };
      (this.hyperedges.delete(i), this.hyperedges.set(D("hyperedge", o.nodes), o));
    }
    (this.invalidateAnalysisCache(), this.emitChange());
  }
  addSimplex(t) {
    ...
    let n = {
      ...
      i = w(n.nodes);
    return (this.simplices.set(i, n), Bt(this, n), this.invalidateAnalysisCache(), this.emitChange(), i);
  }
  removeSimplex(t) {
  ...
  updateHyperedge(t, e) {
    ...
    return (
      ...
      e.weight !== void 0 && (i.weight = Re(e.weight)),
  ...
  facesImpliedByPromotion(t) {
    ...
    return e ? ct(this, { nodes: e.nodes }) : [];
  }
  ...
  getAllRelations() {
    ...
    return (
      this.simplices.forEach((e, n) => {
        t.push({ key: D("simplex", e.nodes), relation: { kind: "simplex", ...e } });
      }),
  ...
  getCachedBetti() {
    return !this._analysisDirty && this._analysisCache ? (this._analysisCache.betti ?? Me(this, 2)) : Me(this, 2);
  }
  computeAnalysisSummary() {
    let t = [...this.simplices.values()],
      ...
      n = new Map(),
      i = new Map();
    (this.nodes.forEach((g, m) => n.set(m, new Set())),
      this.nodes.forEach((g, m) => i.set(m, 0)),
      e.forEach((g) => {
        let [m, y] = g.nodes;
        (n.get(m)?.add(y), n.get(y)?.add(m));
      }),
      t.forEach((g) => {
        g.nodes.forEach((m) => {
          i.set(m, (i.get(m) ?? 0) + 1);
  ...
  replayAt(t) {
    ...
    return (
      this.events
        ...
        .forEach((i) => {
          let s = D("simplex", [...i.nodes]),
            o = D("hyperedge", [...i.nodes]);
          switch (i.type) {
            case "encountered":
            case "recurred":
              n.set(o, i.nodes);
        ...
        ? [
            {
              ...
              source: D("hyperedge", [...t.nodes]),
              target: D("simplex", [...t.nodes]),
...
var ts = new Set(["encountered", "recurred", "created", "promoted", "relaxed", "crystallized", "dissolved"]);
function zt(r) {
...
function jt(r) {
  ...
  return !ts.has(n) || s.length === 0 || Number.isNaN(o)
    ? null
    : Object.freeze({
        timestamp: o,
        type: n,
...
var ns = { opened: 1, edited: 1, focused: 0.7, query: 0.5, recency: 0.25 },
  is = { halfLifeMinutes: 30, sourceWeights: ns };
function ht(r) {
...
var ke = class {
    ...
    register(t, e, n = Date.now()) {
      ...
      this.stamps.set(t, { value: ht(Math.max(s, i)), at: n });
    }
    clear() {
      this.stamps.clear();
    }
  ...
  ut = ["pairwise", "simplicial", "hypergraph"];
function ss(r, t) {
...
function Vt(r) {
  return ht(1 - 2 * Math.sqrt(dt(r)));
}
var os = { seed: 20260401, rate: 0.35, threshold: 1e-4, maxIterations: 400 };
async function Yt(r, t, e, n = {}) {
  ...
  let h = (f) => i.nodes.map((g) => f.get(g) ?? 0),
    p = [Vt(h(d))],
    v = null;
  for (let f = 1; f <= s.maxIterations; f++) {
    ...
    d = c.step(d, s.rate);
    let g = h(d);
    if ((p.push(Vt(g)), dt(g) <= s.threshold)) {
      v = f;
      break;
    }
    f % o === 0 && (await a());
...
var as = { k: 8, minClusterSize: 3, maxIterations: 100 };
function gt(r, t = {}) {
  let e = { ...as, ...t };
...
function ls(r, t, e) {
  ...
  for (let o = 0; o < e; o++) {
    for (let l = 0; l < t; l++) {
      ...
      let u = new Map(),
        d = new Map();
      for (let h of c) for (let [p, v] of h.vector) (d.set(p, (d.get(p) ?? 0) + 1), u.set(p, (u.get(p) ?? 0) + v));
    ...
    for (let l = 0; l < n; l++) {
      ...
      for (let h = 0; h < t; h++) {
        let p = {
            path: `centroid-${h}`,
            vector: s[h],
            magnitude: Math.sqrt([...s[h].values()].reduce((f, g) => f + g * g, 0)),
          },
          v = ft(c, p);
        v > d && ((d = v), (u = h));
      }
...
function ds(r, t, e, n, i = 0) {
  ...
  let p = e.size,
    v = new Set(),
    f = new Set();
  for (let [y, b] of h.entries()) b / p < n.tagRarityThreshold ? v.add(y) : f.add(y);
  let g = u.filter((y) => v.has(y)),
    m = u.filter((y) => f.has(y));
  return (
    (s += g.length * 0.15),
    (s -= m.length * 0.1),
...
function Pe(r, t) {
  let e = new Map(),
    ...
    i;
  if (t.domainSource === "content-cluster") i = gt(r, { k: t.contentClusterCount });
  else if (t.domainSource === "hybrid") {
    let h = gt(r, { k: t.contentClusterCount });
    i = Xt(r, h);
  ...
  for (let h = 0; h < o.length; h++)
    for (let p = h + 1; p < o.length; p++) {
      let v = o[h],
        ...
        b = ds(v, f, n, t, y),
        S = qt(v.id, f.id);
      s.set(S, { a: v.id, b: f.id, strength: b });
    }
  let c = new Map();
  ...
  for (let [h, p] of s) {
    let v = c.get(p.a) ?? 1,
      f = c.get(p.b) ?? 1,
      m = 0.5 + 0.5 * Math.min(1, (d * d) / (v * f));
    s.set(h, { ...p, strength: Math.min(1, p.strength * m) });
  }
...
function hs(r, t) {
  ...
  let e = 0,
    n = 0;
  for (let i = 0; i < r.length; i++) for (let s = i + 1; s < r.length; s++) ((e += W(r[i], r[s], t)), n++);
  return n > 0 ? e / n : 0;
}
function Jt(r, t) {
  let e = new Map(),
...
function nn(r, t) {
  return J(r.n * t.d + t.n * r.d, r.d * t.d);
}
function bt(r, t) {
  return J(r.n * t.d - t.n * r.d, r.d * t.d);
}
function ms(r, t) {
  return J(r.n * t.n, r.d * t.d);
}
function fs(r, t) {
  if (vt(t)) throw new Error("linalg: division by zero");
  return J(r.n * t.d, r.d * t.n);
}
function ys(r) {
  let t = r.map((o) => [...o]),
    e = t.length,
  ...
  for (let o = 0; o < n && s < e; o++) {
    ...
    [t[s], t[a]] = [t[a], t[s]];
    let l = t[s][o];
    for (let c = o; c < n; c++) t[s][c] = fs(t[s][c], l);
    for (let c = 0; c < e; c++) {
      if (c === s || vt(t[c][o])) continue;
      let u = t[c][o];
      for (let d = o; d < n; d++) t[c][d] = bt(t[c][d], ms(u, t[s][d]));
    }
    (i.push(o), s++);
  }
...
function St(r) {
  return r.length === 0 ? 0 : ys(r).pivotColumns.length;
}
var G = ["action", "project", "research", "idea", "creative", "reference"];
function P(r, t) {
  let e = new Set();
  return (
...
function vs(r) {
  return G.map((t) => J(t === r ? 1 : 0));
}
function sn(r, t) {
  let e = new Map(t.map((i) => [i.id, new Set(P(r, i))])),
    n = [];
    ...
    t.contexts.forEach((o) => {
      ...
      a &&
        P(r, o).forEach((l) => {
          ...
          if (!c) return;
          let u = e.length;
          (e.push({ nodeId: l, contextId: o.id, value: vs(c) }),
            s(`n:${l}`, `c:${o.id}`, u, !0),
            s(`c:${o.id}`, `n:${l}`, u, !1));
        });
    }),
...
function on(r, t) {
  ...
  return (
    e.edges.forEach((l, c) => {
      ...
      if (f === -1) return;
      let m = [...h.slice(0, f + 1), ...p.slice(0, g).reverse()],
        y = Ss(m, c, e);
      o.push({
        vertices: m,
        contexts: [...new Set(m.filter((b) => b.startsWith("c:")).map((b) => b.slice(2)))].sort(),
        nodes: [...new Set(m.filter((b) => b.startsWith("n:")).map((b) => b.slice(2)))].sort(),
        holonomy: y,
...
function Ss(r, t, e) {
  let n = G.map(() => J(0)),
    i = (s, o) => {
      n = n.map((a, l) => (o ? nn(a, s.value[l]) : bt(a, s.value[l])));
    };
...
function xt(r, t) {
  ...
  return {
    ...
    cycles: s,
    obstructionRank: l,
    globalBaselineDimension: u ? c * G.length : 0,
    glues: u,
...
function Ms(r, t) {
  ...
  if (xt(r, t).glues) return { value: 1, consistentContexts: e.map((s) => s.id), exact: !0 };
  let n = (s) => xt(r, { contexts: e.filter((o) => s.has(o.id)), sections: t.sections }).glues;
  if (e.length <= Cs) {
...
function Q(r, t) {
  let e = xt(r, t);
  return { gluing: e, obstructions: ws(e), fraction: Ms(r, t), overlaps: sn(r, t.contexts) };
}
function an(r, t, e = {}) {
      ...
      for (let [p, v] of h)
        if (!(l.size > 0 && !l.has(p))) {
          for (let f of G) {
            ...
            g.set(d.id, new Map(h).set(p, f));
            let m = Q(r, { contexts: t.contexts, sections: g }),
              y = {
                obstructionRank: m.gluing.obstructionRank,
                contextualFraction: m.fraction.value,
                localDisagreements: m.gluing.pairwiseDisagreements.length,
                contextualityDetected: m.gluing.contextualityDetected,
              },
              b =
            ...
            b > 1e-9 && c.push({ contextId: d.id, nodeId: p, from: v, to: f, before: o, after: y, score: b });
          }
          if (u >= i) break;
        }
      if (u >= i) break;
...
function ln(r) {
  return [
    ...[...r.simplices.values()].filter((t) => !t.autoGenerated).map((t) => D("simplex", t.nodes)),
    ...r.hyperedges.keys(),
  ].sort();
}
...
var Ns = { contexts: [], sections: {}, audit: [] };
function cn(r) {
  return typeof r == "string" && G.includes(r);
}
function Le(r) {
  let t = r.sheaf;
  if (!t || typeof t != "object") return Ns;
  let e = t,
    n = Array.isArray(e.contexts) ? e.contexts.filter(un) : [],
    i = {};
  ...
  let s = Array.isArray(e.audit) ? e.audit.filter(hn).map((o) => ({ ...o })) : [];
...
function Ds(r) {
  ...
  return (
    t.forEach((n) => {
      ...
      e[n.id] = Object.fromEntries(Object.entries(i).filter((s) => cn(s[1])));
    }),
    { contexts: t, sections: e, audit: r.audit.filter(hn).map((n) => ({ ...n })) }
  );
}
function hn(r) {
...
function Y(r, t) {
  ...
  return (
    t.nodes.forEach((n, i) => {
      ...
      if (!(s instanceof Ae.TFile)) return;
...
function wt(r, t, e, n, i) {
  let s = (a) => {
      ...
      if (!(l instanceof Ae.TFile)) return !1;
      let c = r.metadataCache.getFileCache(l),
        u = [...(c?.tags ?? []).map((h) => h.tag?.toLowerCase() ?? ""), ...fn(c?.frontmatter?.tags)],
  ...
  return (
    ...
    t.simplices.forEach((a) => {
      a.autoGenerated || (a.nodes.some(s) && o.push(D("simplex", a.nodes)));
    }),
    o.length === 0 ? null : { id: ue(n, i), name: n, source: e, definition: n, relations: [...new Set(o)].sort() }
  );
}
function He(r, t, e) {
  let n = Y(r, t);
  return Object.fromEntries(P(t, e).map((i) => [i, n.get(i) ?? "reference"]));
}
function pn(r, t, e, n = 12) {
  ...
  return s
    ...
    .map(({ key: a, relation: l, overlap: c }) => {
      let u = l.nodes.map((v) => v.split("/").pop()?.replace(/\.md$/, "")).join(" \xB7 "),
        d = l.label?.trim(),
      ...
      return (
        o.push(p),
        {
          ...
          initialRoles: He(r, t, p),
        }
      );
    });
}
function gn(r, t, e, n = 12) {
  let i = new Map();
  t.nodes.forEach((o, a) => {
    let l = a.lastIndexOf("/");
    if (l > 0) {
    ...
    if (!(c instanceof Ae.TFile)) return;
    let u = r.metadataCache.getFileCache(c);
    [...(u?.tags ?? []).map((d) => d.tag ?? ""), ...fn(u?.frontmatter?.tags)].forEach((d) => {
  ...
  return [...i.values()]
    ...
    .map(({ source: o, definition: a }) => wt(r, t, o, a, e))
    .filter((o) => o !== null)
    .map((o) => {
      let a = new Set(P(t, o)),
        l = e.reduce((c, u) => c + P(t, u).filter((d) => a.has(d)).length, 0);
      return {
        context: o,
        usefulOverlap: l,
        reason: `${o.relations.length} relation${o.relations.length === 1 ? "" : "s"}; useful overlap score ${l}.`,
        initialRoles: He(r, t, o),
      };
    })
...
var bn = { parse: (r) => (0, ee.parseYaml)(r) ?? null, stringify: (r) => (0, ee.stringifyYaml)(r) };
function pe(r, t) {
  return yn(r, t, bn);
}
function ge(r) {
...
function Et(r, t, e) {
  return Ct(r, "simplices", t, e);
}
function Mt(r, t, e) {
  return Ct(r, "hyperedges", t, e);
}
async function Nt(r, t, e) {
  let n = await r.vault.read(t),
    { frontmatter: i, body: s } = ge(n),
    o = w(e.nodes);
  Et(i, o, Sn(e));
...
async function Cn(r, t, e) {
  let n = await U(r, t),
    ...
    { frontmatter: s, body: o } = ge(i),
    a = w(e.nodes);
  ((s.managedBy = "simplicial-complex"), Mt(s, a, xn(e)));
  let l = pe(
    s,
    o ||
...
async function Mn(r, t, e) {
  let n = await U(r, t),
    ...
    { frontmatter: s, body: o } = ge(i),
    a = w(e.nodes);
  ((s.managedBy = "simplicial-complex"), Et(s, a, Sn(e)));
...
`),
  $e = class {
    ...
    async load(t) {
      ...
      if (!(e instanceof Dt.TFile)) return 0;
        ...
        : ((this.flushing = (async () => {
            try {
              for (; this.queue.length > 0; ) {
                let e = this.queue.splice(0, this.queue.length).map((n) => zt(n)).join(`
`);
  ...
  for (let o of n) {
    ...
    for (let l = 0; l < a.length; l++)
      for (let c = l + 1; c < a.length; c++) {
        ...
        e.push({ nodes: [u, o, d], source: "inferred-bridge", bridgeNode: o, triadScore: f, label: null, weight: g });
      }
  }
  return e;
}
...
function In(r, t) {
  ...
  for (let c of r.nodes.keys()) {
    if (o.has(c) || de(c, e, r).length < n) continue;
    let d = new Set([c]),
      h = [c];
        ...
        p.length > 5
          ? p
              .map((m) => ({
                ...
                strength: de(m, e, r)
                  .filter((y) => d.has(y))
                  .reduce((y, b) => y + W(m, b, r), 0),
              }))
              .sort((m, y) => y.strength - m.strength)
              .slice(0, 5)
              .map(({ id: m }) => m)
              .sort()
          : p,
    ...
    a.has(g) ||
      ...
      l.push({
        ...
        triadScore: Number((f.average * v.length).toFixed(2)),
      }));
  }
  return l;
}
...
function Fn(r, t, e = Ps, n, i) {
  ...
  if (e.enableReinforcement && n) {
    let d = t.map((v) => v.id),
      p = 1 + (Qt(n, i, d) - 1) * e.reinforcementStrength;
    u *= p;
  }
...
function An(r, t, e) {
  ...
  if (((s -= h * e.commonTagPenalty), !kn(n, i)))
    return { ...r, insightScore: 0, class: "folder-cluster", decayedWeight: 0 };
  let p =
    i === 2 ? Pn(n, e.minDomainsForTetra, e.minRolesForTetra) : { qualifies: !0, isSuper: !1, class: "cross-domain" };
  if (!p.qualifies) return { ...r, insightScore: 0, class: "folder-cluster", decayedWeight: 0 };
  let v = Fn(r.weight ?? 1, n, {
  ...
  return { ...r, insightScore: s, class: p.class, decayedWeight: v };
}
function Fs(r, t) {
  let e = Pe(r, t),
    n = Tn(e, t),
    ...
    s = new Map();
  [...n, ...i].forEach((p) => {
    let v = [...p.nodes].sort().join("|"),
      f = s.get(v);
    (!f || (p.weight ?? 0) > (f.weight ?? 0)) && s.set(v, p);
  });
  let a = [...s.values()]
      .map((p) => An(p, [...e.nodes.values()], t))
      .filter((p) => p.insightScore >= t.insightThreshold && p.class !== "folder-cluster")
      .sort((p, v) => v.insightScore - p.insightScore)
      .map((p) => ({
        nodes: p.nodes,
...
var Hn = new Set([
  ...
  Os = { en: Hn, fa: As, es: Ls, fr: Hs, de: $s };
function Ks(r) {
  let t = r.toLowerCase().split("-")[0];
  return Os[t] ?? Hn;
}
function $n(r, t = "en") {
  return Ks(t).has(r.toLowerCase());
}
var Bs = "en";
function On(r, t = Bs) {
  return new Set(
...
function js(r) {
  let t = new Set();
  r?.tags?.forEach((i) => t.add(Kn(i.tag)));
  let e = r?.frontmatter?.tags;
  return ((Array.isArray(e) ? e : typeof e == "string" ? [e] : []).forEach((i) => t.add(Kn(String(i)))), t);
}
function Vs(r, t, e) {
  let n = new Set();
  return (
...
function Wn(r, t, e) {
  ...
  return {
    ...
    folder: i,
    topFolder: s,
    titleTokens: On(t.basename),
    contentTokens: On(o),
    tags: js(n),
    outgoingLinks: Vs(t, n, r),
    role: Fe(t, n, e),
      ...
      zs(a, s, o).forEach((c) => {
        ...
        if (
          (t.enableLinkInference !== !1 &&
            ...
            ((f = !0), (p += t.linkWeight), v.push("link:a->b")),
          t.enableMutualLinkBonus !== !1 &&
            h.outgoingLinks.has(d.path) &&
            ((f = !0), (p += t.mutualLinkBonus), v.push("link:b->a")),
          !t.linkGraphBaseline && f && ((p = 0), (f = !1), (v.length = 0)),
          !t.enableInferredEdges && !f)
        )
          return;
        let g = _n(d.tags, h.tags);
        ...
        let m =
          t.enableInferredEdges && t.enableTitleOverlap !== !1
            ? Bn(d.titleTokens, h.titleTokens, t.titleOverlapWeight)
            : 0;
        m > 0 && ((p += m), v.push(`title:${m.toFixed(2)}`));
        let y =
          t.enableInferredEdges && t.enableContentOverlap !== !1
            ? Bn(d.contentTokens, h.contentTokens, t.contentOverlapWeight)
            : 0;
        if (
          (y > 0 && ((p += y), v.push(`content:${y.toFixed(2)}`)),
          t.enableInferredEdges && t.enableSameFolderInference !== !1 && d.folder && d.folder === h.folder
            ? ((p += t.sameFolderWeight), v.push("folder:same"))
            : t.enableInferredEdges &&
              t.enableSameTopFolderInference !== !1 &&
              d.topFolder &&
              d.topFolder === h.topFolder &&
              ((p += t.sameTopFolderWeight), v.push("folder:top")),
        ...
        (e.push({
          ...
          n.set(Oe(d.path, h.path), { nodes: [d.path, h.path], weight: b, signals: [...v] }));
      });
    }),
    t.enableInferredEdges)
  ) {
        ...
        .forEach((c) => {
          ...
          for (let d = 0; d < u.length; d++)
            for (let h = d + 1; h < u.length; h++) {
              let p = u[d].partner,
                v = u[h].partner;
              if ([c, p, v].sort()[0] !== c) continue;
              let g = n.get(Oe(c, p)),
                m = n.get(Oe(c, v)),
                y = n.get(Oe(p, v));
              if (!g || !m || !y) continue;
              let b = new Set([...g.signals, ...m.signals, ...y.signals, "soft-cluster"]);
              e.push({
                nodes: [c, p, v],
                weight: Math.min(1, Number(((g.weight + m.weight + y.weight) / 3 + 0.05).toFixed(2))),
                label: "soft cluster",
                inferred: !0,
                userDefined: !1,
                autoGenerated: !1,
                ...
                confidence: Math.min(1, Number(((g.weight + m.weight + y.weight) / 3 + 0.05).toFixed(2))),
                suggested: !0,
              });
            }
        }));
...
function zn(r, t) {
  let e = t.inferenceMode ?? "taxonomic",
    n = [];
  return (
    (e === "taxonomic" || e === "hybrid") && n.push(...Gs(r, t)),
    (e === "emergent" || e === "hybrid") && n.push(...Ln(r, t)),
    n
  );
}
var Un = require("obsidian");
var jn = /^(△+|simplex:)\s+(.+)$/gim,
  Vn = /^(◇|hyperedge:|encounter:)\s+(.+)$/gim;
function Ys(r, t) {
  let e = r.match(/^---\n([\s\S]*?)\n---/);
  if (!e) return null;
  try {
...
function Gn(r, t) {
  ...
  return Z(e.map((n) => t.canonicalize(n)));
}
function Us(r, t, e) {
...
function qs(r, t, e) {
  ...
  jn.lastIndex = 0;
  let i;
  for (; (i = jn.exec(r)) !== null; ) {
    let s = i[1],
      o = i[2].split(/\s+/).filter(Boolean),
      a = s === "\u25B3\u25B3" ? 4 : s === "\u25B3" ? 3 : o.length,
      l = Z(o.slice(0, a).map((c) => e.canonicalize(c)));
...
function Zs(r, t, e) {
  ...
  Vn.lastIndex = 0;
  let i;
  for (; (i = Vn.exec(r)) !== null; ) {
    let s = i[2].split(/\s+/).filter(Boolean),
      o = Z(s.map((a) => e.canonicalize(a)));
...
function Yn(r, t, e) {
  ...
  (i.simplices.push(...qs(r, t, e)), i.hyperedges.push(...Zs(r, t, e)));
  let s = Js(i);
  return (
...
function Xn(r, t, e) {
  return Yn(r, t, {
    ...
    parseYaml: (i) => (0, Un.parseYaml)(i) ?? null,
  });
}
var Ke = class {
  constructor(t, e, n, i, s) {
    ...
    ((this.debouncedChange = (0, te.debounce)(
      ...
      this.app.vault.on("modify", (o) => {
        (ae(), o instanceof te.TFile && this.debouncedChange(o));
      }),
      this.app.vault.on("create", (o) => {
        (ae(), o instanceof te.TFile && this.debouncedChange(o));
      }),
      this.app.vault.on("delete", (o) => {
        (ae(), this.onFileDelete(o));
      }),
      this.app.vault.on("rename", (o, a) => {
        (ae(), o instanceof te.TFile && this.onFileRename(o, a));
      }));
  }
  ...
  recordWrite(t, e) {
    (this.lastWrittenHash.set(t, X(e)),
  ...
  rebuildInferredSimplices() {
    let t = zn([...this.inferenceContexts.values()], this.settings),
      e =
...
var Be = class {
  ...
  logConfirm(t, e) {
    (V(this.interactionTracker, { type: "confirm", simplexKey: t, nodeIds: e, weight: 0.5 }),
      this.onInteraction?.(this.interactionTracker));
  }
  logReject(t, e) {
    (V(this.interactionTracker, { type: "reject", simplexKey: t, nodeIds: e, weight: -0.3 }),
      this.onInteraction?.(this.interactionTracker));
  }
  logPromote(t, e) {
    (V(this.interactionTracker, { type: "promote", simplexKey: t, nodeIds: e, weight: 0.8 }),
      this.onInteraction?.(this.interactionTracker));
  }
  logDissolve(t, e) {
    (V(this.interactionTracker, { type: "dissolve", simplexKey: t, nodeIds: e, weight: -0.5 }),
      this.onInteraction?.(this.interactionTracker));
  }
  logCreate(t) {
    (V(this.interactionTracker, { type: "create", nodeIds: t, weight: 0.6 }),
      this.onInteraction?.(this.interactionTracker));
  }
  getFocusState() {
    let t = new Set(),
    ...
    (i &&
      ...
      this.model.getHyperedgesForNode(i).forEach((o) => {
        (n.add(D("hyperedge", o.nodes)), o.nodes.forEach((a) => t.add(a)));
      })),
  ...
  selectSimplex(t) {
    if (
      ...
      e && V(this.interactionTracker, { type: "select", simplexKey: t, nodeIds: e.nodes, weight: 0.1 });
    }
  }
  selectHyperedge(t) {
    if (
  ...
  _e = class {
    ...
    tick(t, e, n, i, s = []) {
      ...
      (t.forEach((m) => {
        ...
        e.forEach((m) => {
          let y = m.nodes.length - 1,
            b = m.weight ?? 1,
            S = m.nodes.length === 2 ? 1 : 1 + Math.min(1.2, (m.nodes.length - 2) * 0.4);
          m.nodes.forEach((N) => {
            let E = u.get(N);
            E &&
              (m.nodes.length === 2 && E.edgeCount++,
              m.nodes.length >= 3 && E.clusterCount++,
              (E.maxDim = Math.max(E.maxDim, y)));
          });
          for (let N = 0; N < m.nodes.length; N++)
            for (let E = N + 1; E < m.nodes.length; E++) {
              let R = Zn(m.nodes[N], m.nodes[E]),
                F = (c.get(R) ?? 0) + b * S;
              c.set(R, Math.min(3.5, F));
            }
        }));
      let d = t.length > 0 ? this.calculateBounds(t) : { x: 0, y: 0, width: 1e3, height: 1e3 },
        h = new Rt(d.x, d.y, d.width, d.height);
      (t.forEach((m) => h.insert(m)),
        t.forEach((m) => {
          if (m.isPinned) return;
          let y = h.calculateForce(m, this.BARNES_HUT_THETA, this.REPULSION);
          ((m.vx += y.fx), (m.vy += y.fy));
        }));
      for (let m = 0; m < t.length; m++)
        for (let y = m + 1; y < t.length; y++) {
          let b = t[m],
            ...
            E = S.py - b.py,
            R = Math.hypot(N, E) || 1,
            F = c.get(Zn(b.id, S.id)) ?? 0,
            B = N / R,
            $ = E / R,
            ie = Math.max(0, this.MIN_NODE_SEPARATION - R);
          if (ie > 0 && !this.USE_BARNES_HUT) {
            let _ = ie * this.COHESION * 0.55;
            (b.isPinned || ((b.vx -= _ * B), (b.vy -= _ * $)), S.isPinned || ((S.vx += _ * B), (S.vy += _ * $)));
          }
          if (F > 0) {
            let _ = Math.min(1.6, F),
              se = Math.max(this.MIN_NODE_SEPARATION * 1.05, this.SPARSE_EDGE_LENGTH * (1.08 - _ * 0.2)),
              z = (R - se) * this.COHESION * 0.16 * (1 + F * 0.9),
              Lt = se * 0.68,
              re = Math.max(0, Lt - R) * this.COHESION * 0.28 * (1 + F * 1.1);
            (b.isPinned || ((b.vx += z * B - re * B), (b.vy += z * $ - re * $)),
              S.isPinned || ((S.vx -= z * B - re * B), (S.vy -= z * $ - re * $)));
          }
        }
      if (
        (e.forEach((m) => {
          if (m.nodes.length < 3) return;
          let y = m.nodes.map((E) => l.get(E)).filter(Boolean);
          if (!y.length) return;
          let b = y.reduce((E, R) => E + R.px, 0) / y.length,
            S = y.reduce((E, R) => E + R.py, 0) / y.length,
            N = m.weight ?? 1;
          y.forEach((E) => {
            E.isPinned ||
              ((E.vx += (b - E.px) * this.COHESION * N * 0.75), (E.vy += (S - E.py) * this.COHESION * N * 0.75));
          });
        }),
        s.forEach((m) => {
          let y = m.nodes.map((E) => l.get(E)).filter(Boolean);
          ...
          y.forEach((E) => {
            E.isPinned ||
              ((E.vx += (b - E.px) * this.COHESION * N * 0.5), (E.vy += (S - E.py) * this.COHESION * N * 0.5));
          });
        }),
        i)
      ) {
        ...
        m &&
          t.forEach((y) => {
            if (y === m || y.isPinned) return;
            let b = y.px - m.px,
              S = y.py - m.py,
              N = b * b + S * S + 1;
            ((y.vx += (b / N) * 900), (y.vy += (S / N) * 900));
          });
      }
      let p =
        t.length > 0
          ? { x: t.reduce((m, y) => m + y.px, 0) / t.length, y: t.reduce((m, y) => m + y.py, 0) / t.length }
          : { x: 0, y: 0 };
      t.forEach((m) => {
        if (m.isPinned) return;
        let y = u.get(m.id) ?? { edgeCount: 0, clusterCount: 0, maxDim: 0 },
          b = a ? this.GRAVITY * this.SPARSE_GRAVITY_BOOST : this.GRAVITY,
          S = y.clusterCount > 0 ? 1.2 : y.edgeCount > 0 ? 0.7 : 0.08,
          N = y.clusterCount > 0 ? 0.14 : y.edgeCount > 0 ? 0.08 : 0.01;
        if (
          ((m.vx += (0 - m.px) * b * S + (p.x - m.px) * b * N + (Math.random() - 0.5) * this.NOISE),
          (m.vy += (0 - m.py) * b * S + (p.y - m.py) * b * N + (Math.random() - 0.5) * this.NOISE),
          y.edgeCount === 0 && y.clusterCount === 0)
        ) {
          let R = er(m.id) * Math.PI * 2,
            F = Math.max(this.SPARSE_EDGE_LENGTH * 2.8, 320),
            B = Math.cos(R) * F,
            $ = Math.sin(R) * F;
          ((m.vx += (B - m.px) * b * 0.22), (m.vy += ($ - m.py) * b * 0.22));
        }
        ((m.vx *= this.DAMPING), (m.vy *= this.DAMPING));
        let E = Math.hypot(m.vx, m.vy);
        if (E > this.MAX_VELOCITY) {
          let R = this.MAX_VELOCITY / E;
          ((m.vx *= R), (m.vy *= R));
        }
        ((m.px += m.vx), (m.py += m.vy));
      });
      let v = t.reduce((m, y) => m + y.vx * y.vx + y.vy * y.vy, 0),
        f = t.length > 0 ? v / t.length : 0,
        g = this.GRAVITY > 0 || this.NOISE > 0;
      f < this.SLEEP_THRESHOLD && !this.animationHold && !g && (this.isAsleep = !0);
    }
    calculateBounds(t) {
...
function ei(r) {
  if (r.inferred) {
    let t = tr(r);
    return r.nodes.length >= 3 ? Jn(r) : ni(t, r);
  }
  return Jn(r);
}
function nr(r, t) {
  let e = [...r.simplices.values()].filter((s) => s.nodes.length > t.nodes.length && Qn(t.nodes, s.nodes));
  if (!e.length) return null;
  let n = e.sort((s, o) => o.nodes.length - s.nodes.length || s.nodes.join("|").localeCompare(o.nodes.join("|")))[0];
  return e.some((s) => !Qn(s.nodes, n.nodes)) ? null : n;
}
function L(r, t) {
  if (!r) return ei(t);
  let e = nr(r, t);
...
function or(r, t, e, n) {
  ...
  ((f.width = Math.max(1, Math.ceil(p))), (f.height = Math.max(1, Math.ceil(v))));
  let g = f.getContext("2d");
  if (!g) return null;
  if ((g.translate(-d, -h), (g.fillStyle = "#ffffff"), s.length === 1))
    (g.beginPath(), g.arc(s[0].px, s[0].py, n, 0, Math.PI * 2), g.fill());
  else if (oi(o)) (Tt(g, o[0], o[o.length - 1], n), g.fill());
  else
    for (let y = 0; y < s.length; y++) {
      for (let b = y + 1; b < s.length; b++)
        (Tt(g, { x: s[y].px, y: s[y].py }, { x: s[b].px, y: s[b].py }, n), g.fill());
      (g.beginPath(), g.arc(s[y].px, s[y].py, n, 0, Math.PI * 2), g.fill());
    }
  let m = { canvas: f, x: d, y: h, positions: o };
  return (ii.set(i, m), m);
}
var ar = 8;
function si(r, t, e) {
  if (t.length === 2 || oi(t)) {
    Tt(r, t[0], t[t.length - 1], e);
    return;
  }
  rr(r, sr(ir(t), e));
}
...
function ci(r, t = 2600) {
  return (1 - Math.cos((r / t) * Math.PI * 2)) / 2;
}
function di(r) {
  let t = me(r.opacity) * (r.focused ? 1 : 0.35),
    e = r.deficit === null ? 0.5 : 1 - me(r.deficit),
    n = me(r.pulse);
  return {
    dash: [9, 4 + 11 * (1 - e)],
    strokeAlpha: me(t * 1.5 * (0.85 + 0.3 * n)),
    fillAlpha: me(t * (0.05 + 0.14 * e)),
...
function hr(r, t, e = Date.now()) {
  return r.length === 0 || t <= 0
    ? 0
    : r.reduce((n, i) => {
        let s = Math.max(0, (e - i) / lr);
...
function gi(r, t, e = {}) {
  ...
  let i = e.occurrences ?? n.occurrences ?? [],
    o = n.nodes.map((a) => ur(r, a)).reduce((a, l) => (a === null || l.pressure > a.pressure ? l : a), null);
  return {
    key: t,
    nodes: n.nodes,
    closure: ze(r, t),
    independence: e.score ? dr(r, t, e.score) : null,
    peakOverlap: o,
    occurrences: i,
    vitality: hr(i, e.halfLifeDays ?? 90, e.now),
    persistence: n.persistence === "recurring" ? "recurring" : "momentary",
  };
}
function mi(r, t, e, n, i, s) {
  if (!i) return;
  let o = new Set();
  t.forEach((a) => {
    ...
    for (let p = 0; p < l.length; p++)
      for (let v = p + 1; v < l.length; v++) {
        ...
        o.has(f) ||
          ...
          r.lineTo(l[v].px, l[v].py),
          r.stroke());
      }
  });
}
function fi(r, t, e, n, i, s = null) {
...
function yi(r, t, e) {
  ...
  let l = fi(r, a, 14, 14, e);
  r.restore();
}
function vi(r, t, e, n = 14) {
  ...
  (r.save(),
    ...
    fi(r, l, 14, n, e, "rgba(127, 119, 221, 0.35)"),
    r.restore());
}
function bi(r, t, e, n, i) {
  ...
  for (let l of s) pr(r, l, a, e, n, i);
  r.restore();
}
function pr(r, t, e, n, i, s) {
  ...
  let h = 300,
    ...
    v = Math.max(...l.map((S) => S.px)),
    f = Math.min(...l.map((S) => S.py)),
    g = Math.max(...l.map((S) => S.py));
  if (v < i.minX - h || p > i.maxX + h || g < i.minY - h || f > i.maxY + h) return;
  let m = [...t.boundaryNodes].sort().join("|"),
    y = s === m;
    ...
    t.forEach((i, s) => {
      ...
      if (!(o.length < 2)) {
        ...
        for (let a = 1; a < o.length; a++) {
          ...
          for (let g = 1; g <= f; g++) {
            let m = g / f,
              y = g === f ? 0 : (g % 2 === 0 ? -1 : 1) * (5 + s * 1.5);
            r.lineTo(l.px + u * m + p * y, l.py + d * m + v * y);
          }
        }
...
function mr(r) {
  ...
  let e = t.strongestSubset?.map(xi).join(" \xB7 ");
...
function yr(r) {
  ...
  return !t || t.pressure < 0.4
    ? null
    : `${xi(t.nodeId)} sits in ${t.incidentEncounters} encounters that barely overlap each other. It may be carrying contexts that do not belong together.`;
}
function wi(r, t) {
  return {
    headline:
...
function Ci(r, t, e, n) {
  ...
  return r.inferred ? vr(r, s, e, o) : r.autoGenerated ? br(r) : Sr(r, s);
}
function vr(r, t, e, n) {
...
var Ge = class {
  ...
  rankVisibleNodes(t, e) {
    ...
    return [...t].sort((a, l) => {
      let c = this.nodeVisualPriority(a),
        ...
        v = (l.id === s ? 6 : 0) + (l.id === o ? 5 : 0) + (e.has(l.id) ? 4 : 0) + (l.isPinned ? 2 : 0) + h;
      if (p !== v) return v - p;
  ...
  getRenderableSimplices(t, e, n) {
    return t
      .filter(([, s]) => !this.replayState || this.replayState.simplices.has(D("simplex", s.nodes)))
  ...
  getRenderableHyperedges(t) {
    return this.settings.showHyperedges
      ? [...this.model.hyperedges.entries()].filter(
          ([, e]) =>
            (!this.replayState || this.replayState.hyperedges.has(D("hyperedge", e.nodes))) &&
  ...
  findHoleAtPoint(t) {
    ...
    for (let o of e) {
      ...
      let c = l.reduce((p, v) => ({ x: p.x + v.px, y: p.y + v.py }), { x: 0, y: 0 });
  ...
  updateViewTransform(t) {
    ...
    ((this.viewZoom = p * this.userZoom),
      (this.viewOffsetX = this.W / 2 - v * this.viewZoom + this.userPanX),
  ...
  encounterDeficit(t) {
    return ze(this.model, t)?.deficit ?? null;
  }
  ...
  drawHoveredNodeOverlay(t) {
    ...
    let h = s ? Math.min(320, t.measureText(s).width) : 0,
      ...
      g = Math.min(Math.max(24, u.y - v - 18), this.H - v - 12);
  ...
  drawFormalSimplex(t, e, n) {
    let i = Ve(e, this.model.getAllNodes());
  ...
  render() {
    ...
    let t = this.ctx,
      ...
      n = [...this.model.simplices.entries()]
        ...
        .sort((g, m) => m[1].nodes.length - g[1].nodes.length),
    ...
    (this.settings.formalMode
      ? l.forEach(([g, m]) => {
          ...
          (y === 1 && !this.settings.showEdges) ||
            ...
            (this.drawFormalSimplex(t, m, !i.isActive || i.involvesSimplex(m, g)), this.drawSuggestionOverlay(t, g, m));
        })
      : l.forEach(([g, m]) => {
          let y = m.nodes.length - 1;
          (y === 1 && !this.settings.showEdges) ||
            (y === 2 && !this.settings.showClusters) ||
            (y >= 3 && !this.settings.showCores) ||
            (li(t, g, m, this.model, e, this.alphaForDimension(y, i.isActive), i), this.drawSuggestionOverlay(t, g, m));
        }),
      this.settings.formalMode ||
        mi(
          t,
    ...
    let v = new Set();
    (c.forEach(([g, m]) => {
      let y = !i.isActive || i.involvesRelation({ kind: "hyperedge", ...m }, g),
        b = p > 0 && g === i.hoveredHyperedgeKey;
      (b && m.nodes.forEach((S) => v.add(S)),
        ai(
          t,
          m,
          e,
          ...
          di({
            opacity: this.settings.hyperedgeOpacity * (m.suggested ? 0.62 : 1),
            focused: y,
            deficit: this.encounterDeficit(g),
            emergent: !m.suggested && m.persistence === "recurring" && !m.crystallizedInto,
            pulse: b ? p : 0,
          }),
        ));
    }),
      this.sheafReport?.obstructions.length &&
        Si(t, this.sheafReport.obstructions, new Map(e.map((g) => [g.id, g])), this.isDark),
      o.forEach((g) => {
        this.controller.lerpAlpha(g, i);
        let m = g.id === i.hoveredNodeId,
          y = !i.isActive || i.involvesNode(g.id),
          b = this.model.getSimplicesForNode(g.id)[0] ?? null,
          [S, N, E] = b ? L(this.model, b) : [136, 135, 128];
        m &&
          (t.beginPath(), t.arc(g.px, g.py, 15, 0, Math.PI * 2), (t.fillStyle = `rgba(${S},${N},${E},0.10)`), t.fill());
        let R = this.settings.formalMode ? 4.5 : m ? 7 : 5,
          F = v.has(g.id) ? hi(R, p) : R,
          B = this.activation.get(g.id) ?? 0,
          $ = Math.min(1, (y ? g.displayAlpha : 0.2) + B * 0.5);
        (t.beginPath(),
          g.isVirtual
            ? (t.arc(g.px, g.py, F, 0, Math.PI * 2),
              (t.strokeStyle = `rgba(${S},${N},${E},${$})`),
              (t.lineWidth = 1.5),
              t.stroke())
            : (t.arc(g.px, g.py, F, 0, Math.PI * 2), (t.fillStyle = `rgba(${S},${N},${E},${$})`), t.fill()),
          g.isPinned &&
            (t.beginPath(),
            ...
            t.lineTo(g.px - 5, g.py - 13),
            t.closePath(),
            (t.fillStyle = `rgba(${S},${N},${E},0.8)`),
            t.fill()),
          (t.font = `${m ? "500" : "400"} 12px system-ui, sans-serif`));
        let ie = this.formatNodeLabel(g.id),
          _ = d < h,
          se = this.canPlaceLabelFast(u, ie, g.px, g.py - 13),
          Ce = this.measureTextWidth(t, ie) + 12,
          z = this.nodeVisualPriority(g),
          it = m || i.lockedNodeId === g.id || g.isPinned,
          re = z.bucket >= 3,
          Hi = z.bucket === 2,
          $i = z.bucket === 0;
        if (
          !(
            it ||
            (re && _ && se) ||
            (Hi && d < Math.max(2, Math.floor(h * 0.45)) && se) ||
            (!$i && i.isActive && _ && se)
          )
        )
          return;
    ...
    (f && yi(t, this.model, this.isDark),
      this.settings.showHyperedges && vi(t, this.model, this.isDark, f ? 46 : 14),
      this.settings.enableBettiComputation &&
        bi(t, this.model, this.isDark, this.getVisibleWorldBounds(), this.hoveredHoleKey));
  }
...
var ne = require("obsidian"),
  Ft = `You are reading an Obsidian vault that uses the Simplicial Complex plugin.
...
Return a ranked table followed by detailed evidence. Do not edit the vault until I explicitly select proposal IDs.`,
  Mi = `TASK \u2014 CONTEXTUALITY CANDIDATES
...
function Ye(r, t, e = !1) {
  ...
  (e || s("Copy combined prompt", Ri),
    s("Copy encounter prompt", Ni),
    s("Copy contextuality prompt", Di),
...
var Pt = class extends ne.Modal {
  onOpen() {
    ...
    ([
      ...
      this.addPrompt("Combined discovery prompt", Ri),
      this.addPrompt("Encounter-only prompt", Ni),
      this.addPrompt("Contextuality-only prompt", Di));
  }
  addPrompt(t, e) {
  ...
  Ue = class extends K.Modal {
    ...
    render() {
      ...
      (new K.Setting(e)
        ...
        new K.Setting(e).setName("Label").addText((s) => {
...
var Xe = class extends qe.Modal {
  ...
  onOpen() {
    ...
    if (
      ...
      e.createEl("p", {
        text: `You are asserting that ${this.nodes.map(Ii).join(" \xB7 ")} is not only meaningful as a whole, but that its sub-relations are meaningful too.`,
      }),
      this.faces.length === 0)
    )
      ...
      this.faces.forEach((i) => {
        n.createEl("li", { text: i.map(Ii).join(" \u2014 ") });
      });
    }
    (e.createEl("p", {
...
var k = require("obsidian");
var Ze = class extends k.ItemView {
  constructor(e, n) {
    super(e);
    this.model = n;
  ...
  renderPanel() {
    ...
    (this.renderBadge(l, n.autoGenerated ? "Auto face" : n.inferred ? "Inferred" : "Confirmed", [s, o, a]),
      ...
      this.renderJourney(e, n.nodes, D("simplex", n.nodes)),
      n.inferred &&
        (e.createEl("div", {
    ...
    (new k.Setting(e).setName("Label").addText((d) => {
  ...
  renderHyperedgePanel(e, n) {
    ...
    (new k.Setting(e)
      ...
      new k.Setting(e).addExtraButton((d) => {
        (d.setIcon("trash"),
  ...
  renderExplanationCard(e, n) {
    let i = j(this.model, 2),
      s = Ci(n, this.nodeProfiles, new Map(), i),
...
var we = {
  ...
  Je = class extends fe.ItemView {
    ...
    async run() {
      ...
      if (e.length === 0) {
        new fe.Notice("No encounters to run. Record one with \u25C7 first.");
        return;
      }
      this.isRunning = !0;
      ...
      for (let i of e) {
        ...
        (this.runs.push({ key: i, label: s.label?.trim() || s.nodes.map((a) => ki(a)).join(" \xB7 "), results: o }),
          await Pi());
      }
    ...
    renderCompetingRhythms(e) {
      ...
      (s.createEl("div", { cls: "simplicial-panel-section-label", text: "Competing rhythms" }),
        i.slice(0, 5).forEach((o) => {
          s.createEl("div", {
            cls: "simplicial-measure-reading",
            text: `${o.sharedNodes.map(ki).join(" \xB7 ")} belongs to two encounters that settle ${o.separation} iterations apart. It is being asked to move at two speeds.`,
          });
        }));
    }
  };
...
var Cr = ["manual", "folder", "tag", "query", "moc"],
  Qe = class extends T.ItemView {
    constructor(e, n, i, s) {
      super(e);
      this.model = n;
      this.settings = i;
    ...
    renderSuggestions(e, n) {
      let i = pn(this.app, this.model, n.contexts),
      ...
      (s.createEl("div", { cls: "simplicial-panel-section-label", text: "Suggested starting cover" }),
        ...
        this.showDerivedSeeds &&
          gn(this.app, this.model, n.contexts).forEach(({ context: o, reason: a, initialRoles: l }) => {
            new T.Setting(s)
    ...
    renderCreator(e, n) {
      ...
      let s = "",
        ...
        a = "",
        l = new Set();
      (new T.Setting(i).setName("Name").addText((d) => d.onChange((h) => (s = h.trim()))),
      ...
      (c.forEach((d) => {
        new T.Setting(u).setName(this.relationLabel(d)).addToggle((h) => {
        ...
        new T.Setting(i).addButton((d) => {
          (d.setButtonText("Add context").setCta(),
            d.onClick(async () => {
              ...
              let h = (o === "folder" || o === "tag") && a ? wt(this.app, this.model, o, a, n.contexts) : null,
                p = l.size > 0 ? [...l] : (h?.relations ?? []);
              if (p.length === 0) {
                new T.Notice("Select at least one relation, or use a folder/tag that matches one.");
                return;
              }
              let v = ue(s, n.contexts);
              (n.contexts.push({ id: v, name: s, source: o, definition: a, relations: [...new Set(p)].sort() }),
                (n.sections[v] = {}),
                O(n, {
    ...
    renderReport(e, n) {
      let i = he(this.model, n, Y(this.app, this.model)),
        s = Q(this.model, i),
    ...
    renderScratch(e, n) {
      ...
      let o = Q(this.model, he(this.model, s, Y(this.app, this.model)));
      (i.createEl("div", {
        cls: "simplicial-measure-reading",
    ...
    renderContext(e, n, i) {
      ...
      (Object.keys(n.sections[s.id] ?? {}).length === 0 &&
        ...
        new T.Setting(o)
          ...
          .addButton((h) => {
            (h.setButtonText("Prepare starter worksheet").setCta(),
              h.onClick(async () => {
                let p = He(this.app, this.model, s),
                  v = s.name;
                (/^inferred relation$/i.test(s.name) &&
                  ((s.name = l.map(H).join(" \xB7 ")),
        ...
        n.contexts
          .filter((h) => h.id !== s.id)
          .map((h) => ({ other: h, nodes: l.filter((p) => P(this.model, h).includes(p)) }))
          .filter((h) => h.nodes.length > 0)
          .forEach(({ other: h, nodes: p }) => {
            (o.createEl("div", {
              cls: "simplicial-context-overlap",
              text: `Intersection with ${h.name}: ${p.map(H).join(" \xB7 ")}`,
            }),
              o.createEl("div", {
                cls: "simplicial-measure-reading",
      ...
      let d = he(this.model, n, Y(this.app, this.model)).sections.get(s.id);
      if (
        (l.forEach((h) => {
          ...
          (p.addDropdown((v) => {
            (G.forEach((f) => {
              ...
              v.setValue(d?.get(h) ?? "reference"),
              v.onChange((f) => {
                (async () => {
                  var m, y;
                  (m = n.sections)[(y = s.id)] ?? (m[y] = {});
                  let g = n.sections[s.id][h];
                  ((n.sections[s.id][h] = f),
                    O(n, {
                      action: "role-refined",
                      contextId: s.id,
            ...
            p.addButton((v) =>
              v.setButtonText("Compare readings").onClick(() => {
        ...
        let h = Y(this.app, this.model),
          p = o.createDiv({ cls: "simplicial-sheaf-comparison" });
        (p.createEl("div", { cls: "simplicial-panel-section-label", text: `Readings of ${H(this.compareNodeId)}` }),
          mn(this.model, n, h, this.compareNodeId).forEach((v) => {
            p.createEl("div", { text: `${v.contextName}: ${v.role} \xB7 ${v.provenance}` });
          }));
      }
      (this.renderContextRestructuring(o, n, s.id),
        new T.Setting(o).addButton((h) => {
    ...
    renderContextRestructuring(e, n, i) {
      ...
      let o = n.contexts.find((a) => a.id !== s.id && P(this.model, a).some((l) => P(this.model, s).includes(l)));
      o &&
        new T.Setting(e)
          ...
          .addButton((a) => {
            a.setButtonText("Accept merge seed").onClick(async () => {
              let l = ue(`${s.name} + ${o.name}`, n.contexts);
              (n.contexts.push({
                id: l,
                name: `${s.name} + ${o.name}`,
                source: "manual",
    ...
    async persist(e) {
      (dn(this.settings, e), await this.onChanged(), this.render());
    }
    renderAudit(e, n) {
    ...
    relationLabel(e) {
      if (e.startsWith("h:")) {
        ...
        return `\u25C7 ${s?.label?.trim() || s?.nodes.map(H).join(" \xB7 ") || e}`;
      }
    ...
    roleSummary(e) {
      ...
      let i = n.slice(0, 4).map(([s, o]) => `${H(s)} \u2192 ${o}`);
...
var et = class extends Li.ItemView {
  ...
  computeFiltrationEvents() {
    ...
    (this.sliderWrap && this.sliderWrap.removeClass("simplicial-hidden"),
      (this.filtrationEvents = Fi(this.model, this.settings.renderFilterMetric)),
  ...
  renderFiltrationControls(e) {
    ...
    (c.addEventListener("input", () => {
      ((h = Number(c.value)), (p = 0), (d.value = "0"), v());
    }),
  ...
  addDualSlider(e, n, i, s, o, a, l) {
    ...
    let v = c.createDiv({ cls: "simplicial-control-row" });
    v.createSpan({ text: "Fine", cls: "simplicial-slider-label" });
    let f = v.createEl("input", { type: "range" });
    ((f.min = "-0.05"), (f.max = "0.05"), (f.step = "0.001"), (f.value = "0"));
    let g = i,
      m = 0,
      y = () => {
        let b = Math.max(o, Math.min(a, g + m));
        return (d.setText(b.toFixed(4)), s(b), b);
      };
    (p.addEventListener("input", () => {
      ((g = Number(p.value)), (m = 0), (f.value = "0"), y());
    }),
  ...
  updateEventMarkers() {
    if (
      ...
      return;
    let e = Ai(this.filtrationEvents);
...
var tt = class extends x.PluginSettingTab {
  constructor(e, n) {
    super(e, n);
    this.plugin = n;
  }
        ...
        (n.addOption("source-note", "Source note"),
          ...
          n.onChange(async (i) => {
            ...
            ((this.plugin.settings.persistenceMode = s),
              s === "central-file" && (await U(this.app, this.plugin.settings.centralFile)),
          ...
          n.onChange(async (i) => {
            ((this.plugin.settings.centralFile = i || "_simplicial.md"),
              this.plugin.settings.persistenceMode === "central-file" &&
                (await U(this.app, this.plugin.settings.centralFile)),
              await this.plugin.saveSettings());
          }));
      }));
  }
  ...
  addWeightSlider(e, n, i, s, o, a, l, c) {
    let u = new x.Setting(e).setName(n).setDesc(i),
      d = null,
      h = (p) => {
        let v = c >= 1 ? 0 : (`${c}`.split(".")[1]?.length ?? 0);
        return p
          .toFixed(v)
          .replace(/\.0+$/, "")
          .replace(/(\.\d*?)0+$/, "$1");
    ...
    (u.addToggle((p) => {
      (p.setTooltip("Enable or disable this inference signal"),
        ...
        p.onChange(async (v) => {
          ((this.plugin.settings[o] = v), d?.setDisabled(!v), await this.plugin.saveSettings());
        }));
    }),
      u.addSlider((p) => {
        d = p;
        let v = u.controlEl.createSpan({ cls: "simplicial-setting-value" });
        (v.setText(h(this.plugin.settings[s])),
          p.setLimits(a, l, c),
          p.setValue(this.plugin.settings[s]),
          p.setDisabled(!this.plugin.settings[o]),
          p.onChange(async (f) => {
            (v.setText(h(f)), (this.plugin.settings[s] = f), await this.plugin.saveSettings());
          }));
      }));
  }
};
var nt = class extends M.Plugin {
  constructor() {
    super(...arguments);
    this.panelView = null;
    ...
    this.subsetScorer = null;
    this.activation = new ke();
    this.activationTimer = null;
  }
  async onload() {
    let e = (await this.loadData()) ?? {};
    this.settings = Rn(Dn(), e);
    ...
    (this.settings.maxRenderedDim === 3 && (this.settings.maxRenderedDim = 12),
      ...
      (this.model = new Te()),
      (this.history = new Ie()),
      (this.historyStore = new $e(this.app, this.settings.historyFile)),
    ...
    (s && this.controller.setInteractionTracker(tn(s)),
      (this.renderer = new Ge(this.model, this.engine, this.controller, this.settings, {
...
${a.prompt}`,
      ...
      this.registerView(le, (o) => {
        let a = new Ze(o, this.model);
        return (
          a.setActions({
      ...
      this.registerView(ve, (o) => {
        let a = new Qe(o, this.model, this.settings, async () => {
      ...
      this.settings.enableDynamicsLab &&
        (this.registerView(be, (o) => new Je(o, this.model)),
        this.addCommand({
      ...
      this.registerEvent(
        this.app.vault.on("modify", (o) => {
          o instanceof M.TFile && this.registerActivation(o.path, "edited");
        }),
      ),
      this.model.subscribe(() => {
        this.engine.wake();
  ...
  async confirmSuggestedEncounter(e) {
    ...
    (this.model.addHyperedge(s),
      ...
      new M.Notice("Encounter confirmed and recorded."));
  }
  ...
  refreshActivation() {
    ...
    let e = this.activation.field(),
      n = pt(this.model, "hypergraph");
    (this.renderer.setActivation(Gt(n, e, 3)),
      this.engine.wake(),
      e.size !== 0 &&
...
`),
      a = [
        "---",
        `originatingEncounter: "${D("hyperedge", n.nodes)}"`,
        "crystallizedFrom:",
        o,
    ...
    if (n) {
      if (n.suggested) {
        (this.model.removeHyperedge(e),
          ...
          new M.Notice("Encounter suggestion dismissed."));
        return;
      }
...
`),
  ...
  async logPersistenceState() {
    (C.info("plugin", "Persistence state", {
      ...
      this.settings.persistenceMode === "central-file"
        ? await Nn(this.app, this.settings.centralFile)
  ...
  async persistSimplex(e) {
    if (
      ...
      let { file: o, content: a } = await Mn(this.app, this.settings.centralFile, {
        ...e,
        sourcePath: this.settings.centralFile,
      });
  ...
  async openNodeNote(e) {
    let n = this.app.vault.getAbstractFileByPath(e),
      i = n instanceof M.TFile ? n : Ee(e, e, this.app);
    if (!(i instanceof M.TFile)) {
  ...
  async dissolveSimplex(e) {
    ...
    if (
      ...
      let s = await U(this.app, this.settings.centralFile),
  ...
  async openPanel(e, n) {
    ...
    (await i.setViewState({ type: le, active: n }),
