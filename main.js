...
var Li = (r, t) => {
    for (var e in t) et(r, e, { get: t[e], enumerable: !0 });
  },
  Hi = (r, t, e, n) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of Fi(t))
        !Ai.call(r, i) && i !== e && et(r, i, { get: () => t[i], enumerable: !(n = Pi(t, i)) || n.enumerable });
    return r;
  };
var Oi = (r) => Hi(et({}, "__esModule", { value: !0 }), r);
var yr = {};
Li(yr, { default: () => Ze });
module.exports = Oi(yr);
...
function Y(r) {
  ...
  return r ? t[G(r) % t.length] : "purple";
}
function ee(r) {
  return r.toLowerCase().trim();
}
function E(r) {
  return [...r].map(ee).sort().join("|");
}
var Ki = { simplex: "s", hyperedge: "h" };
function M(r, t) {
  return `${Ki[r]}:${E(t)}`;
}
function I(r) {
  return [...r].sort((t, e) => ee(t).localeCompare(ee(e)));
}
function U(r) {
  let t = new Set(),
    e = [];
...
function we(r, t, e) {
  ...
  return i || ($i(e).get(ee(n)) ?? null);
}
var ue = "simplicial-view",
  ne = "simplicial-panel",
  pe = "simplicial-sheaf",
  ge = "simplicial-dynamics";
function Ht(r) {
...
function* ie(r, t) {
  ...
  for (let e = 0; e <= r.length - t; e++) for (let n of ie(r.slice(e + 1), t - 1)) yield [r[e], ...n];
}
function it(r, t) {
  if (Ht(t) >= 4) return [];
  let n = I(t.nodes),
    i = [];
  for (let s = 2; s < n.length; s++) for (let o of ie(n, s)) r.simplices.has(E(o)) || i.push(I(o));
  return i;
}
function Ot(r, t) {
  let e = Ht(t);
...
function st(r, t = 2) {
  ...
  t >= 1 && l.push(..._i(n, i, s));
  let c = [];
  return (t >= 2 && c.push(...Bi(s, o)), { b0: a, b1: l.length, b2: c.length, holes: [...l, ...c] });
}
function Wi(r, t) {
...
var Me = class {
  ...
  setNode(t, e) {
    ...
    let i = Vi(t, void 0, e?.isVirtual ?? !1);
  ...
  addSimplex(t) {
    ...
    let n = {
        ...
        colorKey: t.autoGenerated ? (t.colorKey ?? "neutral") : (t.colorKey ?? Y(t.label)),
      },
      i = E(n.nodes);
  ...
  addHyperedge(t) {
    ...
    let n = I(e),
      ...
      a = {
        ...
        colorKey: t.colorKey ?? o?.colorKey ?? Y(t.label),
  ...
  updateHyperedge(t, e) {
    ...
    return (
      e.label !== void 0 && (i.colorKey = Y(e.label)),
  ...
  facesImpliedByPromotion(t) {
    ...
    return e ? it(this, { nodes: e.nodes }) : [];
  }
  ...
  updateMetadata(t, e) {
    ...
    if (!n) return;
    let i = { ...n, ...e };
    (e.label !== void 0 && (i.colorKey = n.autoGenerated ? "neutral" : Y(e.label)),
      e.weight !== void 0 && (i.weight = Ne(e.weight)),
...
var Gi = new Set(["encountered", "recurred", "created", "promoted", "relaxed", "crystallized", "dissolved"]);
function $t(r) {
...
function Wt(r) {
  ...
  return !Gi.has(n) || s.length === 0 || Number.isNaN(o)
    ? null
    : Object.freeze({
        timestamp: o,
        type: n,
...
var Yi = { opened: 1, edited: 1, focused: 0.7, query: 0.5, recency: 0.25 },
  Ui = { halfLifeMinutes: 30, sourceWeights: Yi };
function ot(r) {
...
var Re = class {
    ...
    register(t, e, n = Date.now()) {
      ...
      this.stamps.set(t, { value: ot(Math.max(s, i)), at: n });
    }
    clear() {
      this.stamps.clear();
    }
  ...
  at = ["pairwise", "simplicial", "hypergraph"];
function Xi(r, t) {
...
function _t(r) {
  return ot(1 - 2 * Math.sqrt(rt(r)));
}
var Zi = { seed: 20260401, rate: 0.35, threshold: 1e-4, maxIterations: 400 };
async function zt(r, t, e, n = {}) {
  ...
  for (let f = 1; f <= s.maxIterations; f++) {
    ...
    d = c.step(d, s.rate);
    let p = u(d);
    if ((g.push(_t(p)), rt(p) <= s.threshold)) {
      m = f;
      break;
    }
    f % o === 0 && (await a());
...
var Ji = { k: 8, minClusterSize: 3, maxIterations: 100 };
function ct(r, t = {}) {
  let e = { ...Ji, ...t };
...
function me(r, t) {
  let e = new Map(),
    ...
    i;
  if (t.domainSource === "content-cluster") i = ct(r, { k: t.contentClusterCount });
  else if (t.domainSource === "hybrid") {
    let u = ct(r, { k: t.contentClusterCount });
    i = Vt(r, u);
...
function Jt(r, t) {
  return X(r.n * t.d + t.n * r.d, r.d * t.d);
}
function gt(r, t) {
  return X(r.n * t.d - t.n * r.d, r.d * t.d);
}
function os(r, t) {
  return X(r.n * t.n, r.d * t.d);
}
function as(r, t) {
  if (pt(t)) throw new Error("linalg: division by zero");
  return X(r.n * t.d, r.d * t.n);
}
function ls(r) {
  let t = r.map((o) => [...o]),
    e = t.length,
  ...
  for (let o = 0; o < n && s < e; o++) {
    ...
    [t[s], t[a]] = [t[a], t[s]];
    let l = t[s][o];
    for (let c = o; c < n; c++) t[s][c] = as(t[s][c], l);
    for (let c = 0; c < e; c++) {
      if (c === s || pt(t[c][o])) continue;
      let h = t[c][o];
      for (let d = o; d < n; d++) t[c][d] = gt(t[c][d], os(h, t[s][d]));
    }
    (i.push(o), s++);
  }
...
function mt(r) {
  return r.length === 0 ? 0 : ls(r).pivotColumns.length;
}
var B = ["action", "project", "research", "idea", "creative", "reference"];
function q(r, t) {
  let e = new Set();
  return (
...
function cs(r) {
  return B.map((t) => X(t === r ? 1 : 0));
}
function Qt(r, t) {
  let e = new Map(t.map((i) => [i.id, new Set(q(r, i))])),
    n = [];
    ...
    t.contexts.forEach((o) => {
      ...
      a &&
        q(r, o).forEach((l) => {
          ...
          if (!c) return;
          let h = e.length;
          (e.push({ nodeId: l, contextId: o.id, value: cs(c) }),
            s(`n:${l}`, `c:${o.id}`, h, !0),
            s(`c:${o.id}`, `n:${l}`, h, !1));
        });
    }),
...
function hs(r, t, e) {
  let n = B.map(() => X(0)),
    i = (s, o) => {
      n = n.map((a, l) => (o ? Jt(a, s.value[l]) : gt(a, s.value[l])));
    };
...
function fs(r, t) {
  ...
  if (ft(r, t).glues) return { value: 1, consistentContexts: e.map((s) => s.id), exact: !0 };
  let n = (s) => ft(r, { contexts: e.filter((o) => s.has(o.id)), sections: t.sections }).glues;
  if (e.length <= gs) {
...
function se(r, t) {
  let e = ft(r, t);
  return { gluing: e, obstructions: ps(e), fraction: fs(r, t), overlaps: Qt(r, t.contexts) };
}
function nn(r, t, e = {}) {
      ...
      for (let [g, m] of u)
        if (!(l.size > 0 && !l.has(g))) {
          for (let f of B) {
            if (f === m || h >= i) continue;
            h++;
            let p = new Map(t.sections);
            p.set(d.id, new Map(u).set(g, f));
            let y = se(r, { contexts: t.contexts, sections: p }),
              v = {
                h1: y.gluing.h1,
            ...
            b > 1e-9 && c.push({ contextId: d.id, nodeId: g, from: m, to: f, before: o, after: v, score: b });
          }
          if (h >= i) break;
        }
      if (h >= i) break;
...
var ys = { contexts: [], sections: {} };
function rn(r) {
  return typeof r == "string" && B.includes(r);
}
function Ie(r) {
  let t = r.sheaf;
  if (!t || typeof t != "object") return ys;
  let e = t,
    n = Array.isArray(e.contexts) ? e.contexts.filter(an) : [],
    i = {};
  return (
...
function ye(r, t) {
  ...
  return (
    t.nodes.forEach((n, i) => {
      ...
      if (!(s instanceof yt.TFile)) return;
...
function ln(r, t, e, n, i) {
  ...
  return (
    ...
    o.length === 0 ? null : { id: ke(n, i), name: n, source: e, definition: n, relations: [...new Set(o)].sort() }
  );
}
function cn(r, t, e = 12) {
  ...
  return i
    ...
    .map(({ key: o, relation: a, overlap: l }) => {
      ...
      return (
        s.push(d),
        { context: d, reason: `Shares ${l.length} participant${l.length === 1 ? "" : "s"} with another relation.` }
      );
    });
}
function Ss(r) {
...
var un = { parse: (r) => (0, Z.parseYaml)(r) ?? null, stringify: (r) => (0, Z.stringifyYaml)(r) };
function re(r, t) {
  return dn(r, t, un);
}
function oe(r) {
...
function bt(r, t, e) {
  return vt(r, "simplices", t, e);
}
function St(r, t, e) {
  return vt(r, "hyperedges", t, e);
}
async function xt(r, t, e) {
  let n = await r.vault.read(t),
    { frontmatter: i, body: s } = oe(n),
    o = E(e.nodes);
  bt(i, o, pn(e));
...
async function fn(r, t, e) {
  let n = await z(r, t),
    i = await r.vault.read(n),
    { frontmatter: s, body: o } = oe(i),
    a = E(e.nodes);
  ((s.managedBy = "simplicial-complex"), St(s, a, gn(e)));
  let l = re(
    s,
    o ||
...
async function z(r, t) {
  ...
  if (e instanceof Z.TFile) return e;
  let n = [
      "---",
...
async function vn(r, t, e) {
  let n = await z(r, t),
    ...
    { frontmatter: s, body: o } = oe(i),
    a = E(e.nodes);
  ((s.managedBy = "simplicial-complex"), bt(s, a, pn(e)));
...
`),
  Pe = class {
    ...
    async load(t) {
      ...
      if (!(e instanceof wt.TFile)) return 0;
        ...
        : ((this.flushing = (async () => {
            try {
              for (; this.queue.length > 0; ) {
                let e = this.queue.splice(0, this.queue.length).map((n) => $t(n)).join(`
`);
...
function Nn(r, t, e = Es, n, i) {
  ...
  if (e.enableReinforcement && n) {
    let d = t.map((m) => m.id),
      g = 1 + (Xt(n, i, d) - 1) * e.reinforcementStrength;
    h *= g;
  }
...
function Et(r, t, e) {
  ...
  if (((s -= u * e.commonTagPenalty), !Cn(n, i)))
    return { ...r, insightScore: 0, class: "folder-cluster", decayedWeight: 0 };
  let g =
    i === 2 ? En(n, e.minDomainsForTetra, e.minRolesForTetra) : { qualifies: !0, isSuper: !1, class: "cross-domain" };
  if (!g.qualifies) return { ...r, insightScore: 0, class: "folder-cluster", decayedWeight: 0 };
  let m = Nn(r.weight ?? 1, n, {
...
var Rn = new Set([
  ...
  Is = { en: Rn, fa: Ms, es: Ds, fr: Rs, de: Ts };
function ks(r) {
...
function An(r, t, e) {
  ...
  return {
    ...
    folder: i,
    topFolder: s,
    titleTokens: In(t.basename),
    contentTokens: In(o),
    tags: Hs(n),
    outgoingLinks: Os(t, n, r),
    role: Te(t, n, e),
      ...
      Ls(a, s, o).forEach((c) => {
        ...
        let y =
          t.enableInferredEdges && t.enableTitleOverlap !== !1
            ? Pn(d.titleTokens, u.titleTokens, t.titleOverlapWeight)
            : 0;
        y > 0 && ((g += y), m.push(`title:${y.toFixed(2)}`));
        let v =
          t.enableInferredEdges && t.enableContentOverlap !== !1
            ? Pn(d.contentTokens, u.contentTokens, t.contentOverlapWeight)
            : 0;
        if (
        ...
        (e.push({
          ...
          n.set(Fe(d.path, u.path), { nodes: [d.path, u.path], weight: b, signals: [...m] }));
      });
    }),
    t.enableInferredEdges)
  ) {
...
function Ln(r, t) {
  let e = t.inferenceMode ?? "taxonomic",
    n = [];
  return (
    (e === "taxonomic" || e === "hybrid") && n.push(...Nt(r, t)),
    (e === "emergent" || e === "hybrid") && n.push(...Mn(r, t)),
    n
  );
}
var Wn = require("obsidian");
var Hn = /^(△+|simplex:)\s+(.+)$/gim,
  On = /^(◇|hyperedge:|encounter:)\s+(.+)$/gim;
function Ks(r, t) {
  let e = r.match(/^---\n([\s\S]*?)\n---/);
  if (!e) return null;
  try {
...
function Kn(r, t) {
  ...
  return U(e.map((n) => t.canonicalize(n)));
}
function $s(r, t, e) {
...
function _s(r, t, e) {
  ...
  Hn.lastIndex = 0;
  let i;
  for (; (i = Hn.exec(r)) !== null; ) {
    let s = i[1],
      o = i[2].split(/\s+/).filter(Boolean),
      a = s === "\u25B3\u25B3" ? 4 : s === "\u25B3" ? 3 : o.length,
      l = U(o.slice(0, a).map((c) => e.canonicalize(c)));
...
function Bs(r, t, e) {
  ...
  On.lastIndex = 0;
  let i;
  for (; (i = On.exec(r)) !== null; ) {
    let s = i[2].split(/\s+/).filter(Boolean),
      o = U(s.map((a) => e.canonicalize(a)));
...
function $n(r, t, e) {
  ...
  (i.simplices.push(..._s(r, t, e)), i.hyperedges.push(...Bs(r, t, e)));
  let s = zs(i);
  return (
...
function _n(r, t, e) {
  return $n(r, t, {
    canonicalize: (i) => we(i, t, e)?.path ?? i.trim(),
    parseYaml: (i) => (0, Wn.parseYaml)(i) ?? null,
  });
}
var Ae = class {
  constructor(t, e, n, i, s) {
    ...
    ((this.debouncedChange = (0, J.debounce)(
      (o) => {
        this.onFileChange(o);
      },
      100,
      ...
      this.app.vault.on("modify", (o) => {
        (te(), o instanceof J.TFile && this.debouncedChange(o));
      }),
      this.app.vault.on("create", (o) => {
        (te(), o instanceof J.TFile && this.debouncedChange(o));
      }),
      this.app.vault.on("delete", (o) => {
        (te(), this.onFileDelete(o));
      }),
      this.app.vault.on("rename", (o, a) => {
        (te(), o instanceof J.TFile && this.onFileRename(o, a));
      }));
  }
  ...
  recordWrite(t, e) {
    (this.lastWrittenHash.set(t, G(e)),
  ...
  processFile(t, e) {
    ...
    (this.model.replaceSourceRelations(t.path, n.simplices, n.hyperedges),
      ...
      this.inferenceContexts.set(t.path, An(this.app, t, e)),
  ...
  rebuildInferredSimplices() {
    ...
    if (
      ...
      if (
        ((t = Dn([...this.inferenceContexts.values()], this.settings, s)), this.settings.inferenceMode === "hybrid")
      ) {
        let o = Nt([...this.inferenceContexts.values()], this.settings),
          a = new Set(t.map((c) => c.nodes.sort().join("|"))),
          l = o.filter((c) => !a.has(c.nodes.sort().join("|")));
        t.push(...l);
      }
    } else t = Ln([...this.inferenceContexts.values()], this.settings);
    let e =
    ...
    tick(t, e, n, i, s = []) {
      ...
      for (let p = 0; p < t.length; p++)
        for (let y = p + 1; y < t.length; y++) {
          let v = t[p],
            ...
            w = b.py - v.py,
            D = Math.hypot(S, w) || 1,
            k = c.get(zn(v.id, b.id)) ?? 0,
            L = S / D,
            O = w / D,
            ce = Math.max(0, this.MIN_NODE_SEPARATION - D);
          if (ce > 0 && !this.USE_BARNES_HUT) {
            let K = ce * this.COHESION * 0.55;
            (v.isPinned || ((v.vx -= K * L), (v.vy -= K * O)), b.isPinned || ((b.vx += K * L), (b.vy += K * O)));
          }
          if (k > 0) {
            let K = Math.min(1.6, k),
              de = Math.max(this.MIN_NODE_SEPARATION * 1.05, this.SPARSE_EDGE_LENGTH * (1.08 - K * 0.2)),
              W = (D - de) * this.COHESION * 0.16 * (1 + k * 0.9),
              he = de * 0.68,
              V = Math.max(0, he - D) * this.COHESION * 0.28 * (1 + k * 1.1);
            (v.isPinned || ((v.vx += W * L - V * L), (v.vy += W * O - V * O)),
              b.isPinned || ((b.vx -= W * L - V * L), (b.vy -= W * O - V * O)));
          }
        }
      if (
        (e.forEach((p) => {
      ...
      t.forEach((p) => {
        ...
        if (
          ...
          let D = Vs(p.id) * Math.PI * 2,
            k = Math.max(this.SPARSE_EDGE_LENGTH * 2.8, 320),
            L = Math.cos(D) * k,
            O = Math.sin(D) * k;
          ((p.vx += (L - p.px) * v * 0.22), (p.vy += (O - p.py) * v * 0.22));
        }
...
function Gn(r) {
  if (r.inferred) {
    let t = Gs(r);
    return r.nodes.length >= 3 ? jn(r) : Un(t, r);
  }
  return jn(r);
}
function Ys(r, t) {
  let e = [...r.simplices.values()].filter((s) => s.nodes.length > t.nodes.length && Vn(t.nodes, s.nodes));
  if (!e.length) return null;
  let n = e.sort((s, o) => o.nodes.length - s.nodes.length || s.nodes.join("|").localeCompare(o.nodes.join("|")))[0];
  return e.some((s) => !Vn(s.nodes, n.nodes)) ? null : n;
}
function A(r, t) {
  if (!r) return Gn(t);
  let e = Ys(r, t);
...
function Zs(r, t, e, n) {
  ...
  else if (Jn(o)) (Dt(p, o[0], o[o.length - 1], n), p.fill());
  else
    for (let v = 0; v < s.length; v++) {
      for (let b = v + 1; b < s.length; b++)
        (Dt(p, { x: s[v].px, y: s[v].py }, { x: s[b].px, y: s[b].py }, n), p.fill());
...
function ti(r, t = 2600) {
  return (1 - Math.cos((r / t) * Math.PI * 2)) / 2;
}
function ni(r) {
  let t = ae(r.opacity) * (r.focused ? 1 : 0.35),
    e = r.deficit === null ? 0.5 : 1 - ae(r.deficit),
    n = ae(r.pulse);
  return {
    dash: [9, 4 + 11 * (1 - e)],
    strokeAlpha: ae(t * 1.5 * (0.85 + 0.3 * n)),
    fillAlpha: ae(t * (0.05 + 0.14 * e)),
...
function si(r) {
  ...
  return (
    r.hyperedges.forEach((i, s) => {
      let o = i.nodes,
        a = o.length,
        l = a <= Oe ? 2 ** a - a - 1 : Number.POSITIVE_INFINITY;
      if (a > Oe) {
...
function nr(r, t, e = Date.now()) {
  return r.length === 0 || t <= 0
    ? 0
    : r.reduce((n, i) => {
        let s = Math.max(0, (e - i) / Qs);
...
function oi(r, t, e = {}) {
  ...
  let i = e.occurrences ?? n.occurrences ?? [],
    o = n.nodes.map((a) => ir(r, a)).reduce((a, l) => (a === null || l.pressure > a.pressure ? l : a), null);
  return {
    key: t,
    nodes: n.nodes,
    closure: Ke(r, t),
    independence: e.score ? tr(r, t, e.score) : null,
    peakOverlap: o,
    occurrences: i,
    vitality: nr(i, e.halfLifeDays ?? 90, e.now),
...
function ci(r, t, e) {
  ...
  let l = li(r, a, 14, 14, e);
  r.restore();
}
function di(r, t, e, n = 14) {
  ...
  (r.save(),
    ...
    li(r, l, 14, n, e, "rgba(127, 119, 221, 0.35)"),
    r.restore());
}
function hi(r, t, e, n, i) {
  ...
  for (let l of s.betti.holes) sr(r, l, a, e, n, i);
  r.restore();
}
function sr(r, t, e, n, i, s) {
...
function or(r) {
  ...
  let e = t.strongestSubset?.map(pi).join(" \xB7 ");
...
function lr(r) {
  ...
  return !t || t.pressure < 0.4
    ? null
    : `${pi(t.nodeId)} sits in ${t.incidentEncounters} encounters that barely overlap each other. It may be carrying contexts that do not belong together.`;
}
function gi(r, t) {
  return {
    headline:
...
function mi(r, t, e, n) {
  ...
  return r.inferred ? cr(r, s, e, o) : r.autoGenerated ? dr(r) : hr(r, s);
}
function cr(r, t, e, n) {
...
var _e = class {
  ...
  findSimplexAtPoint(t) {
    ...
    for (let i of e) {
      let s = We(i, this.model.getAllNodes());
      if (s.length === 2) {
        let [o, a] = s,
          l = a.x - o.x,
          c = a.y - o.y,
  ...
  encounterDeficit(t) {
    return Ke(this.model, t)?.deficit ?? null;
  }
  ...
  drawFormalSimplex(t, e, n) {
    let i = We(e, this.model.getAllNodes());
  ...
  drawSuggestionOverlay(t, e, n) {
    ...
    let i = We(n, this.model.getAllNodes());
    if (i.length < 2) return;
  ...
  render() {
    ...
    (this.settings.formalMode
      ...
      : l.forEach(([p, y]) => {
          ...
          (v === 1 && !this.settings.showEdges) ||
            (v === 2 && !this.settings.showClusters) ||
            (v >= 3 && !this.settings.showCores) ||
            (ei(t, p, y, this.model, e, this.alphaForDimension(v, i.isActive), i), this.drawSuggestionOverlay(t, p, y));
        }),
      this.settings.formalMode ||
        ai(
          t,
    ...
    (c.forEach(([p, y]) => {
      ...
      this.sheafReport?.obstructions.length &&
        ui(t, this.sheafReport.obstructions, new Map(e.map((p) => [p.id, p])), this.isDark),
      o.forEach((p) => {
        ...
        let y = p.id === i.hoveredNodeId,
          ...
          [S, w, D] = b ? A(this.model, b) : [136, 135, 128];
        y &&
          (t.beginPath(), t.arc(p.px, p.py, 15, 0, Math.PI * 2), (t.fillStyle = `rgba(${S},${w},${D},0.10)`), t.fill());
        let k = this.settings.formalMode ? 4.5 : y ? 7 : 5,
          L = m.has(p.id) ? ii(k, g) : k,
          O = this.activation.get(p.id) ?? 0,
          ce = Math.min(1, (v ? p.displayAlpha : 0.2) + O * 0.5);
        (t.beginPath(),
          p.isVirtual
            ? (t.arc(p.px, p.py, L, 0, Math.PI * 2),
              (t.strokeStyle = `rgba(${S},${w},${D},${ce})`),
              (t.lineWidth = 1.5),
              t.stroke())
            : (t.arc(p.px, p.py, L, 0, Math.PI * 2), (t.fillStyle = `rgba(${S},${w},${D},${ce})`), t.fill()),
          p.isPinned &&
            (t.beginPath(),
        ...
        let K = this.formatNodeLabel(p.id),
          de = d < u,
          xe = this.canPlaceLabelFast(h, K, p.px, p.py - 13),
          W = this.measureTextWidth(t, K) + 12,
          he = this.nodeVisualPriority(p),
          V = y || i.lockedNodeId === p.id || p.isPinned,
          Ti = he.bucket >= 3,
          Ii = he.bucket === 2,
          ki = he.bucket === 0;
        if (
          !(
            V ||
            (Ti && de && xe) ||
            (Ii && d < Math.max(2, Math.floor(u * 0.45)) && xe) ||
            (!ki && i.isActive && de && xe)
          )
        )
          return;
        ...
        let Ft = 18,
          Je = p.px - W / 2,
          Qe = p.py - 27;
        (h.push({ left: Je, top: Qe, right: Je + W, bottom: Qe + Ft }),
          (t.fillStyle = this.isDark ? "rgba(7,10,18,0.28)" : "rgba(255,255,255,0.42)"),
          t.beginPath(),
          t.roundRect(Je, Qe, W, Ft, 9),
          t.fill(),
    ...
    (f && ci(t, this.model, this.isDark),
      this.settings.showHyperedges && di(t, this.model, this.isDark, f ? 46 : 14),
      this.settings.enableBettiComputation &&
        hi(t, this.model, this.isDark, this.getVisibleWorldBounds(), this.hoveredHoleKey));
  }
...
Return a ranked table followed by detailed evidence. Do not edit the vault until I explicitly select proposal IDs.`,
  yi = `TASK \u2014 CONTEXTUALITY CANDIDATES
...
async function xi(r, t) {
  try {
    (await navigator.clipboard.writeText(r), new Q.Notice(`${t} copied. Paste it into an external agent you trust.`));
  } catch {
    new Q.Notice("Could not access the clipboard. Open the complete guide and copy the prompt manually.");
  }
}
function Be(r, t, e = !1) {
  ...
  (e || s("Copy combined prompt", Si),
    s("Copy encounter prompt", vi),
    s("Copy contextuality prompt", bi),
    i.createEl("button", { text: "Open complete guide" }).addEventListener("click", () => new It(t).open()));
}
var It = class extends Q.Modal {
  onOpen() {
    ...
    ([
      ...
      this.addPrompt("Combined discovery prompt", Si),
      this.addPrompt("Encounter-only prompt", vi),
      this.addPrompt("Contextuality-only prompt", bi));
  }
  addPrompt(t, e) {
    let n = this.contentEl.createEl("details");
    (n.createEl("summary", { text: t }),
      n.createEl("pre").createEl("code", { text: e }),
      new Q.Setting(n).addButton((s) => {
...
var je = class extends Ve.Modal {
  ...
  onOpen() {
    ...
    if (
      ...
      e.createEl("p", {
        text: `You are asserting that ${this.nodes.map(wi).join(" \xB7 ")} is not only meaningful as a whole, but that its sub-relations are meaningful too.`,
      }),
      this.faces.length === 0)
    )
      ...
      this.faces.forEach((i) => {
        n.createEl("li", { text: i.map(wi).join(" \u2014 ") });
      });
    }
    (e.createEl("p", {
...
var Ge = class extends R.ItemView {
  constructor(e, n) {
    super(e);
    this.model = n;
  ...
  renderExplanationCard(e, n) {
    let s = this.model.getAnalysisSummary().betti?.holes ?? [],
      o = mi(n, this.nodeProfiles, new Map(), s),
...
var Se = {
  ...
  Ye = class extends le.ItemView {
    ...
    async run() {
      ...
      if (e.length === 0) {
        new le.Notice("No encounters to run. Record one with \u25C7 first.");
        return;
      }
      this.isRunning = !0;
      ...
      for (let i of e) {
        ...
        (this.runs.push({ key: i, label: s.label?.trim() || s.nodes.map((a) => Ci(a)).join(" \xB7 "), results: o }),
          await Ei());
      }
    ...
    renderCompetingRhythms(e) {
      ...
      (s.createEl("div", { cls: "simplicial-panel-section-label", text: "Competing rhythms" }),
        i.slice(0, 5).forEach((o) => {
          s.createEl("div", {
            cls: "simplicial-measure-reading",
            text: `${o.sharedNodes.map(Ci).join(" \xB7 ")} belongs to two encounters that settle ${o.separation} iterations apart. It is being asked to move at two speeds.`,
          });
        }));
    }
  };
...
var gr = ["manual", "folder", "tag", "query", "moc"],
  Ue = class extends T.ItemView {
    constructor(e, n, i, s) {
      super(e);
      this.model = n;
      this.settings = i;
    ...
    renderSuggestions(e, n) {
      let i = cn(this.model, n.contexts),
          ...
          new T.Setting(s)
            ...
            .addButton((l) => {
              (l.setButtonText("Add seed"),
                l.onClick(async () => {
                  (n.contexts.push(o), (n.sections[o.id] = {}), await this.persist(n));
                }));
            });
        }));
    }
    renderCreator(e, n) {
      ...
      (new T.Setting(i).setName("Name").addText((d) => d.onChange((u) => (s = u.trim()))),
        new T.Setting(i).setName("Source").addDropdown((d) => {
          (gr.forEach((u) => d.addOption(u, u === "moc" ? "MOC note" : u)), d.setValue(o), d.onChange((u) => (o = u)));
        }),
        new T.Setting(i)
          .setName("Definition")
    ...
    renderReport(e, n) {
      let i = fe(this.model, n, ye(this.app, this.model)),
        s = se(this.model, i),
    ...
    renderRefinements(e, n, i) {
      ...
      s.length !== 0 &&
        ...
        s.forEach((o) => {
          let a = n.contexts.find((c) => c.id === o.contextId);
          new T.Setting(e)
            .setName(`${j(o.nodeId)} in ${a?.name ?? o.contextId}`)
            .setDesc(
            ...
            .addButton((c) => {
              (c.setButtonText("Apply reading"),
                c.onClick(async () => {
                  var h, d;
                  ((h = n.sections)[(d = o.contextId)] ?? (h[d] = {}),
                    (n.sections[o.contextId][o.nodeId] = o.to),
                    await this.persist(n));
                }));
            });
        }));
    ...
    renderContext(e, n, i) {
      ...
      let l = q(this.model, s);
      n.contexts
        .filter((u) => u.id !== s.id)
        .map((u) => ({ other: u, nodes: l.filter((g) => q(this.model, u).includes(g)) }))
      ...
      let d = fe(this.model, n, ye(this.app, this.model)).sections.get(s.id);
      (l.forEach((u) => {
        new T.Setting(o).setName(j(u)).addDropdown((g) => {
          (B.forEach((m) => g.addOption(m, m)),
...
function Ni(r, t) {
  let e = [],
    n = [...r.simplices.entries()]
      .map(([a, l]) => ({ key: a, simplex: l, weight: mr(l, t) }))
...
var Xe = class extends Di.ItemView {
  ...
  computeFiltrationEvents() {
    ...
    (this.sliderWrap && this.sliderWrap.removeClass("simplicial-hidden"),
      (this.filtrationEvents = Ni(this.model, this.settings.renderFilterMetric)),
  ...
  updateEventMarkers() {
    if (
      ...
      return;
    let e = Mi(this.filtrationEvents);
        ...
        (n.addOption("source-note", "Source note"),
          ...
          n.onChange(async (i) => {
            ...
            ((this.plugin.settings.persistenceMode = s),
              s === "central-file" && (await z(this.app, this.plugin.settings.centralFile)),
          ...
          n.onChange(async (i) => {
            ((this.plugin.settings.centralFile = i || "_simplicial.md"),
              this.plugin.settings.persistenceMode === "central-file" &&
                (await z(this.app, this.plugin.settings.centralFile)),
              await this.plugin.saveSettings());
          }));
      }));
  }
...
var Ze = class extends N.Plugin {
  ...
  async onload() {
    ...
    ((this.settings = { ...Sn(), ...e }),
      ...
      (this.model = new Me()),
      (this.history = new De()),
      (this.historyStore = new Pe(this.app, this.settings.historyFile)),
    ...
    (n && this.controller.setInteractionTracker(Zt(n)),
      (this.renderer = new _e(this.model, this.engine, this.controller, this.settings, {
...
${s.prompt}`,
      ...
      this.registerView(ne, (i) => {
        let s = new Ge(i, this.model);
        return (
          s.setActions({
      ...
      this.registerView(pe, (i) => {
        let s = new Ue(i, this.model, this.settings, async () => {
      ...
      this.settings.enableDynamicsLab &&
        (this.registerView(ge, (i) => new Ye(i, this.model)),
        this.addCommand({
  ...
  async activateView() {
    ...
    e && (await e.setViewState({ type: ne, active: !1 }));
  }
  async activateDynamicsLab() {
    await this.app.workspace.getLeaf(!0).setViewState({ type: ge, active: !0 });
  }
  async activateSheafView() {
    await this.app.workspace.getLeaf(!0).setViewState({ type: pe, active: !0 });
  }
  refreshSheafAnalysis() {
    let e = Ie(this.settings);
    if (e.contexts.length === 0) {
      (this.renderer.setSheafReport(null), this.sheafView?.refresh());
      return;
    }
    let n = fe(this.model, e, ye(this.app, this.model));
  ...
  syncEncounterState() {
    Kt(this.model, this.history, this.settings.encounterRecurrenceThreshold);
  }
  ...
  refreshActivation() {
    ...
    let e = this.activation.field(),
      n = lt(this.model, "hypergraph");
    (this.renderer.setActivation(Bt(n, e, 3)),
      this.engine.wake(),
      e.size !== 0 &&
  ...
  async persistHyperedge(e) {
    ...
    if (
      ...
      let { file: o, content: a } = await fn(this.app, this.settings.centralFile, {
        ...e,
  ...
  promoteEncounter(e) {
    ...
    new je(this.app, n.nodes, i, async () => {
...
`),
  ...
  async logPersistenceState() {
    (C.info("plugin", "Persistence state", {
      ...
      this.settings.persistenceMode === "central-file"
        ? await bn(this.app, this.settings.centralFile)
  ...
  async persistSimplex(e) {
    if (
      ...
      let { file: o, content: a } = await vn(this.app, this.settings.centralFile, {
        ...e,
        sourcePath: this.settings.centralFile,
      });
  ...
  async openNodeNote(e) {
    let n = this.app.vault.getAbstractFileByPath(e),
      i = n instanceof N.TFile ? n : we(e, e, this.app);
    if (!(i instanceof N.TFile)) {
  ...
  async dissolveSimplex(e) {
    ...
    if (
      ...
      let s = await z(this.app, this.settings.centralFile),
  ...
  async openPanel(e, n) {
    ...
    (await i.setViewState({ type: ne, active: n }),
