 ...
 */
function findUnfilledTriangles(nodeIds: NodeID[], edges: Simplex[], triangles: Simplex[]): Hole[] {
  const holes: Hole[] = [];
 ...
 */
function findHollowTetrahedra(triangles: Simplex[], tetrahedra: Simplex[]): Hole[] {
  const holes: Hole[] = [];
